...
uses
  ...
  UMail in '..\Ortak\UMail.pas' {MailForm},
  ...
  logo_aktar in 'logo_aktar.pas' {logoaktar},
  UGenelAnaSekmeFrame in 'UGenelAnaSekmeFrame.pas' {GenelAnaSekmeFrame: TFrame};
...
//  sleep(2000);
 ...
 { CurrencyString := 'YTL';
  ...
  Application.Title := 'Gentegre --> LKS Muhasebe Entegrasyon Modülü 1.00';
//  Logo.Destroy;
...
//  Application.CreateForm(TDokumDlg, DokumDlg);
  ...
  //Application.CreateForm(Tlogoaktar,logoaktar);
  Randomize;
  Application.Run;
