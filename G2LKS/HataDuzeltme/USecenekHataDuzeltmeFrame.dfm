object SecenekHataDuzeltmeFrame: TSecenekHataDuzeltmeFrame
  Left = 0
  Top = 0
  Width = 592
  Height = 117
  ...
  object hastaKayitErisLink: TJvLinkLabel
    ...
    Height = 13
    Caption = 
      'Bu hatay'#305' Se'#231'eneklerden d'#252'zeltmelisiniz. Se'#231'enekleri a'#231'mak i'#231'in ' +
      '<link>t'#305'klay'#305'n</link>'
    Text.Strings = (
