object ReferansHataDuzeltmeFrame: TReferansHataDuzeltmeFrame
  Left = 0
  Top = 0
  Width = 451
  Height = 101
  ...
  object kodDBText: TDBText
    ...
    Height = 17
    DataField = 'KOD'
    DataSource = ReferansTableDataSource
  end
  ...
  object ReferansTableDataSource: TDataSource
    DataSet = ReferansTable
    Left = 208
  end
  object ReferansTable: TADOQuery
    ...
    SQL.Strings = (
      'SELECT KOD,CARIKODU,MUHKODU FROM REHBER WHERE KOD = :KOD')
    Left = 240
  end
end
