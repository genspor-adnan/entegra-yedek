object HastaHataDuzeltmeFrame: THastaHataDuzeltmeFrame
  Left = 0
  Top = 0
  Width = 445
  Height = 133
  ...
  object kodDBText: TDBText
    ...
    Height = 17
    DataField = 'DOSYANO'
    DataSource = HastaTableDataSource
  end
  ...
  object HastaTableDataSource: TDataSource
    DataSet = HastaTable
    Left = 208
  end
  object HastaTable: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DOSYANO,CARIKODU,MUHASEBEKODU FROM KIMLIK WHERE DOSYANO= ' +
        ':DOSYANO')
    Left = 240
  end
end
