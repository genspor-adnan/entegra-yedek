...
public static class KaynakKatalogu
{
    ...
    private static KaynakTanimi IslemLog() => new(
        ...
        Kolonlar: new KolonTanimi[]
        {
            ...
            new("modul",      TabloAdiIfade("l.tablo_id"),     "metin", "Modül",     Hizalama: "orta"),
            new("kod",        "case l.tablo_id when 71 then kt.kod when 73 then kt.kod when 88 then ks.kod when 30 then kb.belge_no when 903 then kr.kod end",
                                                                "metin", "Kod"),
            new("ad",         "case l.tablo_id when 71 then kt.unvan when 73 then kt.unvan when 88 then ks.ad when 30 then kb.taraf_unvan when 903 then kr.ad end",
                                                                "metin", "Ad"),
