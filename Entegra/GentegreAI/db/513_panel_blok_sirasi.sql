-- =====================================================================
--  513_panel_blok_sirasi.sql
--  Tıp merkezi panelinde "Kurum & sözleşme" ile "Poliklinik akışı" YER
--  DEĞİŞTİRDİ (kullanıcı).
--
--  Sıra bir tercih değil, OKUMA SIRASI: soldaki blok ilk bakılan yerdir.
--  Kurum tahakkuku para tarafını, poliklinik akışı gün içi doluluğu anlatır;
--  kullanıcı önce parayı görmek istedi. Fonksiyonun geri kalanı 512 ile
--  aynıdır - plpgsql gövdesi bütün olarak yeniden yazılır.
--
--  (512 başlığından devam:) Tıp merkezi paneli MOCKUP'LA BİREBİR: 6 kutu + 6 blok.
--
...
--    BLOKLAR : Kurum & sözleşme · Poliklinik akışı · Yardımcı birimler ·
