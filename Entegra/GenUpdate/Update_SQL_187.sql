-- ============================================================
-- Update_SQL_187.sql   (MSSQL)
-- sp_Api_Belge_Kaydet_Json / FATURA.STOKID siralama duzeltmesi
--
-- Bazi eski musteri veritabanlarinda FATURA.STOKID yokken
-- sp_Api_Belge_Kaydet_Json derlenmeye calisinca SP olusmayabiliyor ya da
-- eski haliyle kalabiliyor. Once kolon garanti edilir, sonra son tam
-- sp_Api_Belge_Kaydet_Json tanimi yeniden CREATE OR ALTER edilir.
-- ============================================================

IF COL_LENGTH('dbo.FATURA', 'STOKID') IS NULL
BEGIN
    ALTER TABLE dbo.FATURA ADD STOKID INT NULL;
    PRINT 'Update_SQL_187: FATURA.STOKID kolonu eklendi.';
END
ELSE
    PRINT 'Update_SQL_187: FATURA.STOKID zaten var.';
GO
SET ANSI_NULLS ON;
