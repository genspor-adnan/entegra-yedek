-- ============================================================
-- GenDepoUpdate106.sql
-- ALIMDA IZLEM DAIMA SORULUR - otomatik tek-lot secimi yalniz CIKISTA
--
-- GenDepoUpdate104 "depoda tek aday lot varsa sorma, otomatik sec" kuralini
--   getirmisti. Kural CIKIS icin dogru (mevcut stoktan tuketiyorsun, secenek
--   tek ise soracak bir sey yok) ama ALIS icin YANLIS:
--   mal GELIYOR, lot numarasi TEDARIKCININ irsaliyesinde yaziyor. Depodaki
--   mevcut lotu varsaymak, gelen mala baskasinin lot numarasini yazmak demek.
--
-- Canli hata (08.08.2026): alis siparisi -> alis irsaliyesi donusumunde
--   izlem ekrani hic acilmadi; depodaki tek lot (ti0002) gelen 20 adete
--   atandi ve depoya +20 olarak girdi (belge 114108 / izlem 549478).
--
-- Kural: otomatik secim yalniz hedef CIKIS nitelikliyse (4,14,15,16,20,101,119).
--   Giris belgelerinde her zaman sorulur - tek lot bile olsa.
-- ============================================================
