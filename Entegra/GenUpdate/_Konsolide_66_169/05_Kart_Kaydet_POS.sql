-- ======================================================================
-- KONSOLIDE UPDATE 05 - KART KAYDET / KLONLA / POS / FIYAT
-- ======================================================================
-- 13 nesne, her biri SON hali. 00'dan SONRA, 99'dan ONCE calistir.
...
-- ---- FUNCTION: fn_prog_gecicitablogecerli  (kaynak: GenDepoUpdate138) ----
...
-- ---- PROCEDURE: sp_api_cari_kaydet_json  (kaynak: GenDepoUpdate141) ----
...
-- ---- PROCEDURE: sp_api_cari_klonla_json  (kaynak: GenDepoUpdate141) ----
...
-- ---- PROCEDURE: sp_api_fiyat_eksikleriekle_json  (kaynak: GenDepoUpdate139) ----
-- ============================================================
...
-- ---- PROCEDURE: sp_api_ik_kaydet_json  (kaynak: GenDepoUpdate141) ----
...
-- ---- PROCEDURE: sp_api_ik_klonla_json  (kaynak: GenDepoUpdate141) ----
...
-- ---- PROCEDURE: sp_api_pos_iskonto_json  (kaynak: GenDepoUpdate138) ----
-- ============================================================
...
-- ---- PROCEDURE: sp_api_pos_satis_json  (kaynak: GenDepoUpdate138) ----
-- ============================================================
...
-- ---- PROCEDURE: sp_api_pos_tahsilat_json  (kaynak: GenDepoUpdate157) ----
...
-- ---- PROCEDURE: sp_api_rehber_kaydet_ic  (kaynak: GenDepoUpdate157) ----
...
-- ---- PROCEDURE: sp_api_rehber_klonla_ic  (kaynak: GenDepoUpdate157) ----
...
-- ---- PROCEDURE: sp_api_stok_kaydet_json  (kaynak: GenDepoUpdate157) ----
...
-- ---- PROCEDURE: sp_api_stok_klonla_json  (kaynak: GenDepoUpdate157) ----
