-- ============================================================
-- Update_PG_172.sql   #pg   (PostgreSQL)
-- fn_prog_alissatis_siparis_json2: cikisa SANAL kolonu eklendi
--
-- Update_SQL_172.sql'in PG karsiligi. Cari ekranindaki Alis/Satis gridi TEK grid olup
-- iki liste fonksiyonuyla beslenir; irsaliye/fatura tarafi SANAL donduruyor, siparis
-- tarafi dondurmuyordu. SIPARIS tablosunda SANAL alani yok -> sabit 0 (MSSQL bit -> PG
-- smallint kurali). Kolon RETURNS TABLE'in EN SONUNA eklendi, mevcut sira degismedi.
--
