...
--    IzlemeAktarim   : kaynaktaki seri/lot kayitlari hedefe TASINACAK mi.
--                      YALNIZ kaynagi FATURA olan rotalarda 1'dir: SIPARIS'te
--                      STOKIZLEME kaydi YOKTUR (siparis stok hareketi yapmaz),
--                      orada seri/lot DEPODAN SECILIR - taşinacak bir sey yok.
--                      Eski Pascal akisi da ayni ayrimi yapiyordu:
