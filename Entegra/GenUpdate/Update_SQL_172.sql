-- ============================================================
-- Update_SQL_172.sql   (MSSQL)
-- sp_Prog_AlisSatis_Siparis_Json2: cikisa SANAL kolonu eklendi
--
-- GEREKCE
--   Cari ekranindaki (URehberAraDlg) Alis/Satis alt sekmeleri TEK grid kullanir; grid
--   belge turune gore iki farkli SP ile beslenir:
--       sp_Prog_AlisSatis_IrsFatFisKons_Json2  (irsaliye/fatura/fis/konsinye) -> F.SANAL var
--       sp_Prog_AlisSatis_Siparis_Json2        (siparis/talep)                -> SANAL YOKTU
--   Grid kolonlari Dosya\SatisSiparis.xlsx ile hizalanirken "Sanal" kolonu da eklendi;
--   siparis alt sekmelerinde bu kolonun alani bulunamiyordu.
--   SIPARIS tablosunda SANAL alani YOK (yalniz FATBASLIK'ta) -> sabit 0 donduruluyor.
--   Kolon EN SONA eklendi: mevcut kolon sirasi degismez (kod bazi yerlerde Fields[0]=ID
--   gibi POZISYONEL erisiyor).
--
