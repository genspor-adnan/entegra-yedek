-- ============================================================
-- GenDepoUpdate154.sql
-- MESAJLASMA: grup fotografi (avatar)
--
--   MESAJKANAL.DOSYAID -> GENDEPO.DOSYA (FILESTREAM, hash-dedup). Grup resmi
--   kanal tablosunda blob olarak TUTULMAZ; diger belge/medya ile ayni depoya
--   gider, istemci ULog.DosyaKaydet / DosyaGetir kullanir.
--
--   sp_Api_Mesaj_Kanal_Avatar_Json : grup fotografini ata/kaldir (yonetici)
--   sp_Prog_Mesaj_Kanal_Liste_Json2: listeye GRUPDOSYAID kolonu eklendi
-- ============================================================
SET ANSI_NULLS ON;
...
BEGIN
    ...
    SELECT TOP (CASE WHEN @TopN > 0 THEN @TopN ELSE 2147483647 END)
        ...
        -- Grup basliginin altindaki "Ali, Ayse, Siz" satiri
