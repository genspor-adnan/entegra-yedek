...
USING (VALUES
  ...
  (367, ''STOKIZLEME'',    N''Stok İzleme'', N''Stok''),
  (375, ''STOKIZLEMEDEPO'',N''İzleme Depo'', N''Stok''),
  ...
  (480, ''KASALAR'',       N''Kart'',   N''Kasa''),
  (349, ''DEPOLAR'',       N''Kart'',   N''Depo''),
  (39,  ''HESAPPLANI'',    N''Kart'',   N''Hesap Planı''),
  (52,  ''KULLANICI'',     N''Kart'',   N''Kullanıcı''),
  (58,  ''MASRAFGELIR'',   N''Kart'',   N''Masraf''),
  (481, ''MASRAFGELIR'',   N''Kart'',   N''Gelir''),
  (482, ''KASA'',          N''Hareket'', N''Banka Ödeme''),
  (483, ''KASA'',          N''Hareket'', N''Banka Tahsilat''),
  (209, ''FATBASLIK'',     N''Başlık'', N''Gelen Konsinye''),
  (219, ''FATBASLIK'',     N''Başlık'', N''Giden Konsinye''),
  (214, ''FATBASLIK'',     N''Başlık'', N''Gider Pusulası''),
  -- _USER: kart ek kullanici alanlari (kart ile 1:1, ID=kart ID). LogGeriAl icin gerekli.
