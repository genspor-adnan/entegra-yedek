-- ============================================================
-- GenDepoUpdate5 : sp_liste_perf_indexler
--   GOREVYORUM(GOREVID,TUR,TARIH desc) index - IK NOTLAR alt-sorgusu hizlandirma (~500ms->170ms). Parite etkilenmez.
--   KAPSAM: SP-liste ozelligi (sunucu-tarafi listeleme, KULLANICI_ARAMA Son/Sik Aranan).
--   CALISTIRMA: ANA DB baglantisindan (GENTEGREDB / GENTEGREDB2 ...).
--   IDEMPOTENT: CREATE OR ALTER / IF NOT EXISTS (tekrar guvenli).
-- ============================================================
