-- ============================================================
-- Update_PG_177.sql   #pg   (PostgreSQL)
-- Stok kart KOPYALAMA: paket icerigi (paketdetay) de klonlansin
--
-- Update_SQL_177.sql'in PG karsiligi; ayni gerekce:
--   Klon fonksiyonu stoklar/stokfiyat/stokcevrim/stokseviye/isortagi/stokesdeger/
--   rehberbilgi/imaj tasiyordu, PAKETDETAY yoktu -> paket stogun kopyasi bos paket
--   olarak olusuyordu. urunid = kaynagin kendisi olan satir (paket basligi) klonun
--   kendi id'sine baglanir. Kosulsuz (Ekler/Detay/Resim bayraklarindan bagimsiz).
