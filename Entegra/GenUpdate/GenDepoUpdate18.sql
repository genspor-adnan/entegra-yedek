-- ============================================================
-- GenDepoUpdate18 : sp_Prog_Cari_Liste_Json2  (2-param JSON, guncel)
...
--   sp_Prog_Cari_Liste (tipli) ile GOVDE BIREBIR. Yalniz imza + typed param -> JSON_VALUE cevrimi degisti.
--   @SelectList = ISNULL(@Baslik,N'') (Paramst). Diger tum tipli param'lar JSON_VALUE + TRY_CAST.
--   PARITE MUTLAK: ayni Baslik + ayni degerlerle tipli SP ile ozdes sonuc kumesi.
-- ============================================================
