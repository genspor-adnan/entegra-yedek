-- ============================================================
-- GenDepoUpdate144.sql
-- UInfo LOG LISTESI: "Kopyalama" / "Donusum" islem adi
--
-- GenDepoUpdate143 ile klon ve donusum kayitlari ISLEMLOG'da ALTISLEMTIPI=3/5
--   olarak isaretleniyor. Liste SP'si islem adini yalnizca ISLEMTIPI'den
--   uretiyordu -> ekranda hep "Ekleme" gorunuyordu. Grup icindeki KART satirinin
--   (TABLOID=USTTABLOID) alt tipi varsa ad ondan uretilir.
-- Filtre parametreleri (@Ekleme/@Degistirme/@Silme) DEGISMEDI: kopya/donusum
--   kayitlari yine ISLEMTIPI=1 oldugu icin "Ekleme" filtresinde gelir.
-- ============================================================
SET ANSI_NULLS ON;
