...
var
  ...
  begin
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn, ASQL, [], [], False, nil);
  end;
  ...
  begin
    ...
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'update KASA set DOVIZ_KURU='''+CariDoviz+''', DOVIZ_TUTARI=DOVIZ_TUTARI*'+s+
...
begin
  ...
  BekletDlg.Caption := 'Yıl sonu devirleri oluşturuluyor. Lütfen Bekleyiniz...';
  BekletDlg.Show;
  ...
  //  MemodanSorguCalistir(MemoCariler);
    ...
    BekletDlg.LabelUstTaraf.Caption := 'Cari Kayıtlar Oluşturuluyor.. ';
...
//    MemodanSorguCalistir(MemoKasalar);
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Kasa Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
...
//     MemodanSorguCalistir(MemoBankalar);
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Banka Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
  ...
  if CheckKredi.Checked then begin
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Kredi Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
//     MemodanSorguCalistir(MemoKrediler);
  ...
  if CheckPos.Checked then begin
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Pos Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
//     MemodanSorguCalistir(MemoPOS);
   ...
   if CheckKrediKartlari.Checked then begin
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Kredi Kartı Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
  ...
  if CheckStok.Checked then begin
    ...
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Stok Kayıtları Oluşturuluyor.. ';
    BekletDlg.LabelUstTaraf.Update;
     //Önce Triggerları disable edelim
   ...
   //Önce geçen seneye göre (31/12 ye göre) stok durumlarını alalım
   ...
   YeniBaglantiIleKomutCalistir('EXEC SP_Prg_GenelStokDuruMGuncelle 0,'''+IntToStr(SpinYil.value-1)+'-01-01 00:00'','''+IntToStr(SpinYil.value-1)+'-12-31 23:59'' ');
    ...
    while not Tablo.Query1.Eof do begin
      ...
      BekletDlg.cxProgressBar1.Refresh;
      BekletDlg.LabelUstTaraf.Caption := Tablo.Query1.FieldByName('DEPOADI').AsString + ' için Kayıtlar Oluşturuluyor..';
      BekletDlg.LabelUstTaraf.Update;

      Tablo.TablodanSorguAc(2,'INSERT INTO FATBASLIK (TARIH,FATURATARIH,TUR,TIPI,REHBERID,CIKISDEPO,EKLEYEN ) '
                             +' VALUES (''' //önce çıkış faturası oluşturulur..
      ...
      Tablo.TablodanSorguAc(2,'INSERT INTO FATBASLIK (TARIH,FATURATARIH,TUR,TIPI,REHBERID,GIRISDEPO,EKLEYEN ) '
                             +' VALUES (''' //sonra giriş faturası oluşturulur..
    ...
    //şimdi yeni seneye göre (01/01 den) stok durumlarını alalım

    BekletDlg.cxProgressBar1.Position := 100;
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'İşlem Sonlandırılıyor..';
    BekletDlg.LabelUstTaraf.Update;
...
begin
  ...
  Application.CreateForm(TBekletmeDlg, BekletDlg);
  BekletDlg.cxProgressBar1.Position := 0;
  BekletDlg.Caption := 'Yıl sonu devirleri siliniyor. Lütfen Bekleyiniz...';
  BekletDlg.Show;
  ...
  if CheckCari.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*1/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Cari Kayıtlar Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU='''' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
    IniyeKaydet(CheckCari.Tag,SpinYil.Value,True,False);
    if checkKurFarki.Checked then
      Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR in (88,98) and HESAPTURU='''' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
  ...
  if CheckKasa.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*2/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Kasa Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU=''K'' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
    IniyeKaydet(CheckKasa.Tag,SpinYil.Value,True,False);
  end;
  if CheckBanka.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*3/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Banka Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU=''B'' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
    IniyeKaydet(CheckBanka.Tag,SpinYil.Value,True,False);
  end;
  if CheckKredi.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*4/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Kredi Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU=''R'' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
    IniyeKaydet(CheckKredi.Tag,SpinYil.Value,True,False);
  end;
  if CheckPos.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*5/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Pos Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU = ''P'' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
  ...
  if CheckKrediKartlari.Checked then begin
    ...
    BekletDlg.LabelUstTaraf.Caption := 'Kredi Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'delete from KASA where TUR=2 and HESAPTURU = ''V'' and ISLEMTARIHI between &BasTar and &BitTar ',['&BasTar','&BitTar'],[BasTar,BitTar]);
    IniyeKaydet(CheckKrediKartlari.Tag,SpinYil.Value,True,False);
  end;
  if CheckStok.Checked then begin
    BekletDlg.cxProgressBar1.Position := ABS(100.0*7/8);
    BekletDlg.cxProgressBar1.Refresh;
    BekletDlg.LabelUstTaraf.Caption := 'Stok Kayıtları Siliniyor.. ';
    BekletDlg.LabelUstTaraf.Update;
    ...
    while not Tablo.Query1.IsEmpty do begin
      ...
      BekletDlg.LabelUstTaraf.Update;
      Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,' delete from FATURA where FATBASID=&FatBasID ',['&FatBasID'],[Tablo.Query1.Fields[0].AsInteger]);
      Tablo.Query1.Delete;
    end;
    //Tablo.TumStokDurumlariGuncelle;
...
begin
  if Sil then
     Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'DELETE FROM GENINI WHERE BOLUM='+IntToStr(Ops_DevirIslemleri)+' and ANAHTAR='''+IntToStr(Tur)+''' and DEGER='''+IntToStr(Yil)+''' ',[],[]);
  if Ekle then
     Veritabani.BasitKomutÇalıştır(Tablo.FDCnn,'INSERT INTO GENINI(BOLUM,ANAHTAR,DEGER,DIL) VALUES('+IntToStr(Ops_DevirIslemleri)+','''+IntToStr(Tur)+''','''+IntToStr(Yil)+''','''+IntToStr(Tur)+''') ',[],[]);
End;

procedure TYilSonuDevirIslemleriDlg.SpinYilPropertiesEditValueChanged(
  Sender: TObject);
begin
  Tablo.TablodanSorguAc(2,'select * from GENINI where BOLUM='+IntToStr(Ops_DevirIslemleri)+' and DEGER='''+IntToStr(SpinYil.EditValue)+''' ');   // BOLUM= Devir İşlemleri
