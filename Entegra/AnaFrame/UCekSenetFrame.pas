...
var
  sekmeConfigXml : string =  '<Gentegra>' + #13#10 +
    '<Sekmeler>' + #13#10 +
      ...
      '<Sekme Adi="Çek/Senet Tanımları" Tip="TCekSenetDlg" AnaSekme="hayır"/>' + #13#10 +
      '<Sekme Adi="Rehber Ara" Tip="TRehberAraDlg" AnaSekme="hayır"/>' + #13#10 +
      '<Sekme Adi="Çek/Senet Listesi" Tip="TCekSenetListeFrame" AnaSekme="hayır"/>' + #13#10 +
    '</Sekmeler>' + #13#10 +
  '</Gentegra>';
  ...
  sekmeConfigAramaXml : string = '<Gentegra>' + #13#10 +
    '<Sekmeler>' + #13#10 +
      ...
      '<Sekme Adi="Çek Senet Arama" Tip="TCekSenetAramaFrame" AnaSekme="hayır"/>' + #13#10 +
    '</Sekmeler>' + #13#10 +
  '</Gentegra>';
