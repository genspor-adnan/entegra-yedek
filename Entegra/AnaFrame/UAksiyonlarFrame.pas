...
var
  sekmeConfigXml : string =  '<Gentegra>' + #13#10 +
    '<Sekmeler>' + #13#10 +
      ...
      '<Sekme Adi="Kasa" Tip="TKasaDlg" AnaSekme="hayır"/>' + #13#10 +
      '<Sekme Adi="Kurum" Tip="TKurumDlg" AnaSekme="hayır"/>' + #13#10 +
      '<Sekme Adi="Takvim" Tip="TTakvimDlg" AnaSekme="hayır"/>' + #13#10 +
  ...
  sekmeConfigAramaXml : string = '<Gentegra>' + #13#10 +
    '<Sekmeler>' + #13#10 +
      ...
      '<Sekme Adi="Günlük Aksiyon" Tip="TGunlukAksiyonAramaFrame" AnaSekme="hayır"/>' + #13#10 +
      '<Sekme Adi="Günlük Aksiyon" Tip="TTakvimAksiyonFrame" AnaSekme="hayır"/>' + #13#10 +
    '</Sekmeler>' + #13#10 +
  '</Gentegra>';
