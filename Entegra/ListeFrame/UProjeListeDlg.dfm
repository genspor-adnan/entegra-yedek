  ...
  object SQLMemo: TcxMemo
    ...
    Lines.Strings = (
      ...
      'select '
        ...
        #9'ILGILI,LISTEFIYATI,LISTEKUR,SATISFIYATI,SATISKUR,P.EKLEYEN,P.EK' +
        'LEMETARIHI,P.DEGISTIREN,P.DEGISTIRMETARIHI,'
      ...
      #9'BITISYIL=year(P.BITISTARIHI),'
        ...
        '    DOSYAVAR = CASE WHEN  (Select top 1 COUNT(ID) from GOREVYORU' +
        'M GY where P.ID=GY.GOREVID and GY.TUR=70 and GOREVID=1 )>0 then ' +
        '1 else 0 end,'
