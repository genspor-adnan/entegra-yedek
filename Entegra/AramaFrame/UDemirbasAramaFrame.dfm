object DemirbasAramaFrame: TDemirbasAramaFrame
  ...
  object AraLokasyonbtne: TcxButtonEdit
    ...
    Properties.OnButtonClick = AraLokasyonbtnePropertiesButtonClick
    ShowHint = True
    TabOrder = 5
    OnKeyDown = AraZimmetAlanbtneKeyDown
    Width = 115
  end
  object AraZimmetAlanbtne: TcxButtonEdit
    ...
    Properties.ReadOnly = False
    Properties.OnButtonClick = AraZimmetAlanbtnePropertiesButtonClick
    ShowHint = True
    TabOrder = 6
    OnKeyDown = AraZimmetAlanbtneKeyDown
    Width = 115
  ...
  object AraKategoribtne: TcxButtonEdit
    ...
    Properties.ReadOnly = False
    Properties.OnButtonClick = AraKategori2PropertiesButtonClick
    ShowHint = True
