...
type
  TUretimAramaFrame = class(TFrame, IAramaBilgiFrame, IBilgiFrame)
    ...
    LabelSonArananlar: TToolButton;   // Son Aranan (KULLANICI_ARAMA) - liste frame'de OnClick baglanir
    LabelSikArananlar: TToolButton;   // Sik Aranan (KULLANICI_ARAMA) - liste frame'de OnClick baglanir
    DateBas: TcxDateEdit;
