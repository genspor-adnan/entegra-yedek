...
//             <IcerikSekme Adi="POS Tanımları" Tip="TPOS" AramaTipi="TAramaYokFrame"/>
//		  <IcerikSekme Adi="POS Tanımları Liste" Tip="TPOSListeFrame" AramaTipi="TAramaYokFrame" AramaPropertyAdi="Arama"/>
end;
...
//     Sil(0, '253120');   //nakit krediler
  ...
  if not Tablo.YetkiVarmi(253160,YetkiTur_Gorme) then
     Sil(0, '253160'); //doğrudan borçlanma
