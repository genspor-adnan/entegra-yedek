...
type
  TfrmGelenEvrakKayit = class(TForm)
    ...
    lookupGeldigiYer: TcxDBLookupComboBox;
...
begin
  { TODO -oM�cahit -cGiden/Gelen Evrak : Combolar GENINI den doldurulacak }
...
//  FillCxLookup(qrylookupEvrakCinsi,dslookupEvrakCinsi, lookupEvrakCinsi,'ID', 'ADI', 'SELECT * FROM EVRAK_CINSI');
  ...
  FillCxLookup(qryLookupHavaleBirim,dsLookupHavaleBirim, lookupHavaleEdilecekBirim,'DEGER', 'ANAHTAR', 'SELECT * FROM EVRAK_BIRIMI');
