...
const
   ...
   (Caption : 'Dağıtım';                            Tag:4;  Enabled: True;   FrameClass: TEvrakTanimDagitimFrame),
   (Caption : 'Evrak Özel ALan';                    Tag:5;  Enabled: True;   FrameClass: TEvrakTanimOzelAlanFrame),
   (Caption : 'Gelen Konu Tanımlama';               Tag:6;  Enabled: True;   FrameClass: TEvrakTanimGelenKonuFrame),
   (Caption : 'Gelen Yer Tanımlama';                Tag:7;  Enabled: True;   FrameClass: TEvrakTanimGelenYerFrame),
   ...
   (Caption : 'Dosya Tasnif Plan Grupları';         Tag:10; Enabled: False;   FrameClass: TEvrakTanimDosyaTasnifPlanGrupFrame),
   (Caption : 'Dosya Tasnif Planı';                 Tag:11; Enabled: False;   FrameClass: TEvrakTanimDosyaTasnifPlanFrame),
   (Caption : 'Dosya Tasnif Planı (Birimlere Göre)'; Tag:12;Enabled: False;   FrameClass: TEvrakTanimDosyaTasnifPlanBirimlererGoreFrame),
   (Caption : 'Gizlilik';                           Tag:13; Enabled: False;   FrameClass: TEvrakTanimGizlilikFrame),
   (Caption : 'Yazı Durmu';                         Tag:14; Enabled: False;   FrameClass: TEvrakTanimYaziDurumuFrame),
   (Caption : 'Geliş Şekli';                        Tag:15; Enabled: True;   FrameClass: TEvrakTanimGelisSekliFrame),
   ...
   (Caption : 'İmza Yolu';                          Tag:19; Enabled: True;   FrameClass: TEvrakTanimImzaYoluFrame),
   (Caption : 'Arşiv Klasörleri';                   Tag:20; Enabled: False;   FrameClass: TEvrakTanimArsivKlasorleriFrame),
   ...
   (Caption : 'Dinamik Form Oluştur';               Tag:25; Enabled: False;    FrameClass: TEvrakTanimDinamikFormFrame)
   );
...
{$R *.dfm}
{
  EvrakTanimGoster : Tag -1 Tüm Tanım Sınıfları sekmelerini gösterir
                     Tag 1..25 Yalnızca ilgili Tanım sınıfını gösterir
}
function EvrakTanimGoster( _Tag : integer; _Owner : TComponent; _Parent : TwinControl=Nil) : integer;
var
  frmEvrakTanim: TfrmEvrakTanim;
...
begin
  ...
  if indexSekme = -1 then
    begin
       ...
       // FocusIlkControl kaldırılabilir.
