...
{    TM_AlmaSorgu = Class(TModel)
    ...
    public
        BID : String; //veri BID olarak gelir, aktarım olduktan sonra BID -> VBI olrak değiştirilir ve öyle Alma bildirimine gönderilir.
        ADT : integer;
    end;
...
//        MPA :   Array of TModel;
   ...
   TUrunSorgulaSonucItem = class(TModel)
    public
        ...
        [LMax(20)]  SNO :   String; // Seri/Sıra No.
                    ADT :   Integer;// Adet
        [LMax(23)]  URT :   String; // ÜRT
        [LMax(23)]  SKT :   String; // SKT
        [LMax(23)]  ITT :   String; // İth trh
		    [LMax(23)]  UIK :   String; // Tekil ürünü üreten/ithal eden kurumun numarasıdır.
		    [LMax(16)]	UAK :   String; // Tekil / Lot
		    [LMax(16)]	SKG :   String; // Satarken Kimlik Numarası Gerekli Mi? True / False
		    [LMax(16)]	KKG :   String; // Kullanırken Kimlik Numarası Gerekli Mi? True / False
		    [LMax(64)]	UDI :   String; // Eşsiz kimlik
		    [LMax(128)]	MME :   String; // Marka Model Etiket adı
	 end;
   ...
   TAyrintiUrunSorgulaSonucItem = class(TModel)
    public
        ...
        [LMax(20)] seriNumarasi  :   String; // Seri/Sıra No.
        ...
        [LMax(64)] essizKimlik	 :   String; // Eşsiz kimlik

       // [LMax(23)] olusturulmaTarihi  :   String; // Oluşturma tarihi
        [LMax(100)]	sahibiUnvan :   String; // Sahibi Ünvan

      //  [LMax(23)] sonKullanmaTarihi  :   String; // SKT
        [LMax(23)] ureticiIthalatciKurumNo  :   String; // Tekil ürünü üreten/ithal eden kurumun numarasıdır.  //  ureticiIthalatciKurumNo
      //  [LMax(23)] uretimTarihi  :   String; // ÜRT
        [LMax(100)] urunTanimi :   String; // Ürün Tanımı
...
//        [LMax(23)] sonKullanmaTarihiString  :   String;
   ...
   TAskiSorgulaSonucItem = class(TModel)
    public
        ...
        [LMax(20)]  LNO :   String; // Lot/Batch No.
        [LMax(20)]  SNO :   String; // Seri/Sıra No.
		    [LMax(50)]	BNO	:	String; // Fatura/İrsaliye No.
		    [LMax(16)]	KUN :   String; // Gönderen Kurum Kodu.
                    ADT :   Integer;// Adet
        [LMax(36)]  BID :   String; // Bildirim Kodu.
		    [LMax(64)]	BTI :   String; // Bildirim Tipi.
		    [LMax(19)]	BZA	:	String;	// Bildirim Zamanı. YYYY-AA-GG SS:DD:ss
		    [LMax(164)]	AKU :   String; // Verilen Kurumun adı.
		    [LMax(128)]	MME :   String; // Marka Model Etiket adı
	 end;
   ...
   TBildirimSonucItem = class(TModel)
    public
        ...
        [LMax(5)]   BEN : String;
		    [LMax(23)]  UIK :   String; // Tekil ürünü üreten/ithal eden kurumun numarasıdır.
		    [LMax(10)]	GIT	:	String;	// Bildirim Zamanı. YYYY-AA-GG SS:DD:ss
		    [LMax(164)]	BKU :   String; // Verilen Kurumun adı.
		    [LMax(164)]	DKU :   String; // Marka Model Etiket adı
                    AAD :   Integer;// Adet
...
{    TBildirim = class(TModel)
   ...
   TKabulSonucItem = class(TModel)
    public
        ...
        [LMax(64)]	GKU :   String;	// Gönderen Kurum ünvanı
