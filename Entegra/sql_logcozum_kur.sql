...
CREATE TABLE dbo.LOGCOZUM(
  ...
  KAYNAKTABLO nvarchar(128) NOT NULL,   -- lookup tablosu (GENINI, REHBER...)
  IDKOLON     nvarchar(64)  NOT NULL,   -- degerin arandigi kolon (BOLUM, NO, ID...)
  ADKOLON     nvarchar(64)  NOT NULL,   -- gosterilecek ad kolonu (ANAHTAR, FIRMA, AD...)
  FILTRE      nvarchar(400) NULL,       -- ek WHERE (opsiyonel; ör. BOLUM=-2204)
