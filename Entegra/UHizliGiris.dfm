object HizliGirisDlg: THizliGirisDlg
  ...
  object PanelSol: TPanel
    ...
    object cxGridFatura: TcxGrid
      ...
      object cxGridFaturaDBCardView1: TcxGridDBCardView
        ...
        OnCellClick = cxGridFaturaDBCardView1CellClick
        ...
        object cxGridFaturaDBCardView1IMAJ: TcxGridDBCardViewRow
          ...
          Properties.OnCustomClick = cxGridFaturaDBCardView1IMAJPropertiesCustomClick
        ...
        object cxGridFaturaDBCardView1ACIKLAMA2: TcxGridDBCardViewRow
        ...
        object cxGridFaturaDBCardView1Row2: TcxGridDBCardViewRow
          Tag = 9
          DataBinding.IsNullValueType = True
          Options.Editing = False
        ...
        object cxGridFaturaDBCardViewIZLEME: TcxGridDBCardViewRow
        ...
        object cxGridFaturaDBCardView1Menu: TcxGridDBCardViewRow
          Tag = 9
          Caption = '...'
          DataBinding.IsNullValueType = True
          ...
          Position.BeginsLayer = True
          Styles.Caption = Tablo.cxstTamIade
        end
    ...
    object MemoStoklarANABIRIM: TMemo
      ...
      Lines.Strings = (
        ...
        '        BIRIM2MIKTAR,'
          ...
          #9'MIKTAR=case when F.BIRIM=S.ANABIRIM then @Adet else @Adet*BIRIM' +
          '2MIKTAR end,'
        ...
        #9'STOKLAR S'
          ...
          '        left outer join STOKFIYAT F on S.ID=F.STOKID and F.FIYAT' +
          'ADI=:PFiyatAdi and'
        #9#9'PAKETID= :PPaketID'
        '        left outer join URETIMRECETE UR on S.ID=UR.STOKID'
        ''
        '')
      TabOrder = 3
      Visible = False
    ...
    object PanelSolAlt: TPanel
      ...
      object PanelButonlar: TPanel
        ...
        object PanelTahsilatBelge: TPanel
          ...
          Caption = 'Panel1'
          TabOrder = 0
          object BtnTahsilat: TJvNavPanelButton
            Tag = 1
            Left = 1
            Top = 1
            Width = 174
        ...
        object PanelSil: TPanel
          ...
          object BtnTasi: TJvNavPanelButton
            Left = 81
            Top = 1
            Width = 94
            Height = 46
            Align = alClient
            AllowAllUp = True
            Caption = #220'r'#252'n Ta'#351#305
            Font.Charset = DEFAULT_CHARSET
        ...
        object PanelNakitKK: TPanel
          Left = 0
          Top = 48
          Width = 176
          Height = 48
          Align = alTop
          Caption = 'PanelNakitKK'
          TabOrder = 6
          ...
          object BtnPOS: TJvNavPanelButton
            Tag = 25
            Left = 81
            Top = 1
            Width = 94
        ...
        object PanelKuponAcikHesap: TPanel
          Left = 0
          Top = 96
          Width = 176
          Height = 48
          Align = alTop
          TabOrder = 7
          object BtnKupon: TJvNavPanelButton
            Tag = 200
            Left = 1
            Top = 1
            Width = 80
          ...
          object BtnAcikHesap: TJvNavPanelButton
            Tag = 100
            Left = 81
            Top = 1
            Width = 94
      ...
      object PanelTutar: TPanel
        ...
        object LabelMatrahTutar: TcxLabel
          Left = 203
          Top = 41
          AutoSize = False
          Caption = '0'
    ...
    object MemoAdisyonSatir2: TMemo
      Left = -211
      Top = 226
      Width = 678
      Height = 39
      Lines.Strings = (
        'truncate table TABLOADI'
          ...
          'IZLEME,YERI,YERID,URETICIID,BARKOD,ACIKLAMA,ACIKLAMA2,EKLEYEN,EK' +
          'LEYENAD,RECETEID,RESIM)'
        'select'
        'F.ID, REHBERID,DURUM=0,URUNID,F.TUR,'
        
          'KOD=(case when F.TUR=0 then (select KOD from MASRAFGELIR MG wher' +
          'e MG.ID=F.URUNID) else (select KOD from STOKLAR S where S.ID=F.U' +
          'RUNID) end),'
        
          'AD=(case when F.TUR=0 then (select AD from MASRAFGELIR MG where ' +
          'MG.ID=F.URUNID) else (select S.STOKADI from STOKLAR S where S.ID' +
          '=F.URUNID) end),'
        
          'KATEGORI=(case when F.TUR=0 then 0 else (select KATEGORI from ST' +
          'OKLAR S where S.ID=F.URUNID) end),'
        
          'ADET=ADET-isnull(MF,0.0),MF=isnull(MF,0.0),BIRIM,BIRIMAD=(select' +
          ' TOP 1 ANAHTAR from GENINI where BOLUM = -2702 and DIL=-1 and DE' +
          'GER=F.BIRIM),'
        'MIKTAR=MIKTAR-isnull(MF,0.0),BIRIMFIYAT,'
        'TUTAR=TUTAR-(isnull(MF,0.0)*TUTAR/ADET),'
        'DOVIZ_TUTARI,KUR,DOVIZ_KURU,ISKONTO,ISKONTO2,'
        
          'KDV,isnull(IADEADET,0.0),IZLEME,YERI,YERID,URETICIID=0,BARKOD=(c' +
          'ase when F.TUR=0 then 0 else (select KATEGORI from STOKLAR S whe' +
          're S.ID=F.URUNID) end),'
        'ACIKLAMA,'
        
          'ACIKLAMA2=(case when ADET>1.0 then cast(ADET-isnull(MF,0) as nva' +
          'rchar(10))+'
        
          '+'#39' x'#39'+(SELECT convert(nvarchar(20), cast(BIRIMFIYAT as money), 1' +
          ')) else '#39' '#39' end)+'
        
          ' (case when ISKONTO>0.0 then '#39'%'#39'+cast(ISKONTO as nvarchar(10))+'#39 +
          ' '#304'skonto'#39' else '#39' '#39' end)+'
        
          ' (case when ISKONTO2>0.0 then '#39'%'#39'+cast(ISKONTO2 as nvarchar(10))' +
          '+'#39' '#304'skonto2'#39
        
          ' when ADET<0.0 then CHAR(13)+CHAR(10)+cast(IADEADET as nvarchar(' +
          '10))+'#39' x **'#304'PTAL** '#39' else '#39' '#39' end),'
        
          ' F.EKLEYEN, EKLEYENAD=(select FIRMA from REHBER R where R.ID=F.E' +
          'KLEYEN),'
        ' RECETEID=URETIMPLANID,--UR.ID,'
        
          'RESIM=(case when F.TUR=0 then (select RESIM from MASRAFGELIR MG ' +
          'where MG.ID=F.URUNID) else (select RESIM from STOKLAR S where S.' +
          'ID=F.URUNID) end)'
        ' from'
        ' FATURA F'
        
          ' --left outer join URETIMRECETE UR on F.URUNID=UR.STOKID and F.T' +
          'UR=1'
        'where'
        ' FATBASID= :SID'
        ' and ADET-isnull(MF,0.0)<>0.0'
        'order by F.ID'
        '')
      TabOrder = 7
      Visible = False
    ...
    object PanelSiparis: TPanel
      ...
      object DateTeslim: TcxDBDateEdit
        Left = 246
        Top = 4
        DataBinding.DataField = 'TARIH'
        DataBinding.DataSource = DtsFatBasDetay
        ParentFont = False
      ...
      object EditOdemeTipi: TcxDBButtonEdit
        Left = 70
        Top = 4
        ...
        Properties.OnButtonClick = EditOdemeTipiPropertiesButtonClick
        Style.Color = 16756912
        TabOrder = 1
        Width = 121
      end
      object EditSiparisNotu: TcxDBButtonEdit
        Left = 70
        Top = 27
        ...
        Properties.ReadOnly = True
        TabOrder = 2
        OnClick = EditSiparisNotuClick
        Width = 305
      end
      object EditMusteriBilgi: TcxButtonEdit
        Left = 70
        Top = 52
        ParentColor = True
        Properties.Buttons = <
        ...
        Properties.ReadOnly = True
        TabOrder = 3
        OnClick = EditMusteriBilgiClick
        Width = 305
      end
      object EditAdres: TcxDBButtonEdit
        Tag = 2
        Left = 70
        Top = 77
        Hint = 'Adres'
        ...
        Properties.ReadOnly = True
        Properties.OnButtonClick = EditAdresPropertiesButtonClick
        TabOrder = 4
        Width = 305
      end
    end
  ...
  object TabDetay: TFDQuery
    ...
    SQL.Strings = (
      'select TOP 10 * from fatura ORDER BY ID DESC')
    Left = 25
    Top = 152
  end
  ...
  object cxGridPopupMenu1: TcxGridPopupMenu
    ...
    PopupMenus = <
      item
        ...
        HitTypes = []
        Index = 0
        PopupMenu = UrunPopupMenu1
      end>
    Left = 112
    Top = 88
  end
  object UrunPopupMenu1: TPopupMenu
    Left = 232
    Top = 192
    object UrunSilMenu: TMenuItem
      Caption = 'Sil'
      OnClick = UrunSilMenuClick
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object UrunTasiMenu: TMenuItem
      Caption = #220'r'#252'n Ta'#351#305
    end
    object N4: TMenuItem
      Caption = '-'
    end
    object TekUruneIskontoMenu: TMenuItem
      Tag = 1
      Caption = 'Bu '#220'r'#252'ne '#304'skonto'
      OnClick = BtnSecimeIskontoClick
    end
    object ToplamaIskontoMenu: TMenuItem
      Tag = 2
      Caption = 'Toplama '#304'skonto'
      OnClick = BtnSecimeIskontoClick
    end
  end
end
