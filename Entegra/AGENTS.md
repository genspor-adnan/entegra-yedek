...
ana proje dosyası : "gentegre.dproj"    Bu bir Delphi 12.3 ile yazılmış ERP projesidir.. 
mssql kullanıyorum server adı : DESKTOP-HL3J3AS\SQLEXPRESS  user sa şifre FETAGEN  DB : Henmed
aksini belirtmedikçe Doküman dosyaları oluşturma
