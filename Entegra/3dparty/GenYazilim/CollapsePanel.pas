...
type
  ...
  private
    ...
    function GetHeaderBorderColor: TColor;
  ...
  published
    ...
    property HeaderBorderColor : TColor read GetHeaderBorderColor write SetHeaderBorderColor;
...
begin
  ...
  Caption:='';
  HeaderPanel:=TJvPanel.Create(self);
  ...
  HeaderPanel.FlatBorder := True;
  HeaderPanel.BorderWidth := 1;
  HeaderPanel.OnDblClick := CollapserClick;
...
function TCollapsePanel.GetHeaderBackColor: TColor;
begin
  Result := HeaderPanel.Color;
end;

function TCollapsePanel.GetHeaderBorderColor: TColor;
begin
  Result := HeaderPanel.FlatBorderColor;
end;

procedure TCollapsePanel.SetHeaderBackColor(const Value: TColor);
begin
  HeaderPanel.Color := Value;
end;

procedure TCollapsePanel.SetHeaderBorderColor(const Value: TColor);
begin
  HeaderPanel.FlatBorderColor := Value;
end;
