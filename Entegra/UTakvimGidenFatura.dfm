object TakvimGidenFaturaDlg: TTakvimGidenFaturaDlg
  Left = 0
  Top = 0
  BorderIcons = []
  Caption = 'Giden Fatura Bilgileri'
  ClientHeight = 550
  ClientWidth = 585
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object LabelFTARIH: TcxDBLabel
      ...
      Style.Font.Style = [fsBold]
      Style.IsFontAssigned = True
      OnClick = LabelFATURABASLIKClick
      Height = 22
      Width = 74
    end
  ...
  object TabKasa: TFDQuery
    ...
    SQL.Strings = (
      ...
      #9'R.FIRMA,'
        ...
        #9'ADRES= (SELECT BILGI FROM REHBERBILGI WHERE YERI=1 AND YER_ID=R' +
        '.ID AND ETIKET='#39'Adres'#39'),'
      
        #9'ILCE=(SELECT BILGI FROM REHBERBILGI WHERE YERI=1 AND YER_ID=R.I' +
        'D AND ETIKET='#39#304'l'#231'e'#39'),'
        ...
        #9'F.ID, TUR, F.DURUM,ODEMEPLANI, F.TARIH, FATURATARIH, FATURANO, ' +
        'REHBERID, '
      #9'ACIKLAMA,FATURA_MATRAHI,KDV_TUTARI,FATURA_TUTARI, '
      #9'KUR,F.MASRAFID, F.EKLEYEN,F.DEGISTIREN'
      'from '
