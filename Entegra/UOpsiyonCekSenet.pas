...
begin
   ...
   Tablo.GENINI.WriteInteger(Ops_OpsiyonCekler_BilgilendirmeMail,ComboBilgiEposta.EditValue);//  Opsiyon Çekler  E-Posta İle Bilgilendirme
   Tablo.GENINI.WriteInteger(Ops_OpsiyonCekler_BilgilendirmeSms,ComboBilgiSms.EditValue);//  Opsiyon Çekler  Sms İle Bilgilendirme
   Tablo.GENINI.WriteInteger(Ops_OpsiyonSenetler_BilgilendirmeMail,ComboBilgiEpostaSenet.EditValue);//  Opsiyon Senetler  E-Posta İle Bilgilendirme
   Tablo.GENINI.WriteInteger(Ops_OpsiyonSenetler_BilgilendirmeSms,ComboBilgiSmsSenet.EditValue);//  Opsiyon Senetler  Sms İle Bilgilendirme
