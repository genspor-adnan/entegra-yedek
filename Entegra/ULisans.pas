...
Modul37	Satýnalma
Modul38 Doktorlar
Modul39 Yeni Versiyon Çalýþmasýn
}
...
Begin
  ...
  // DB'deki versiyon alýnýyor. 60 DBdeki versiyonu bulunan KOD.
  // Hiç versiyon kaydý yoksa 20.10.08.99 alýnýyor. Bu sistemin baþlamadan önceki son olasý versiyon bilgisidir.
...
// 09.09.2010 Okan ÜNAL
// Yeni çalýþan Versiyonun bilgilerini sisteme günceller...
  ...
  try
    try
      ...
      begin
       ...
       //LÝSANS Versyion Kontrolü
       // 09.09.2010 Okan ÜNAL
      // Bu çalýþan yeni versiyon mu DB deki ile kontrol edelim.
      DBVersiyon := StrToInt(VersiyonKontrol);

      // Çalýþtýrýlmak istenen versiyon bilgisi Sistemdeki kayýtlý versiyon bilgisinden yeni ise...
      ...
      Begin
        try
          ...
          LisansSorgulandi := False;
          lws := 0;
          raise ELisansHatasi.Create('Yeni versiyonu kullanmaya çalýþtýðýnýz terminalin internet eriþimi olmalýdýr.', 'Ýnternet eriþimi olan bir makineden tekrar deneyiniz.', lhHata, ldHataVerBitir, nil);
        end;

        if LisansSorgulandi then
        Begin
          // Lisans Sorgulandý ve Yeni versiyon kullanmaya yetkisi yok ise.
         ...
         // if (LisansBilgileri.SatisTipi = stCalismasin) then
          ...
          Begin
            raise ELisansHatasi.Create('Lisans bilgilerinize ulaþýlamadý. Lütfen GenoTIP ile görüþünüz.', 'Yeni lisans almanýz gerekebilir.', lhHata, ldHataVerBitir, nil);
          End
          else // Lisans Sorgulandý ve Yeni versiyon kullanmaya yetkisi var ise.
          Begin
      ...
      case LisansBilgileri.SatisTipi of
       ...
       { // 27.09.2010 Okan ÜNAL
         // Yeni Versiyon kontrolü ile birlikte çalýþmasýn kontrolünü deðiþtiriyoruz.
        stCalismasin :
          begin
