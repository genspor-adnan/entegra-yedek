        ...
        //if (LisansliModuller <> nil) and (LisansliModuller.Hata = '') then begin
          ...
          for I := 0 to Length(LisansliModuller.ModulListesi)-1 do begin
            if LisansliModuller.ModulListesi[I].ModulDurumu then begin
              VeriTabani.BasitKomutÇalıştır(Tablo.FDCnn,'update MODUL set L=HashBytes(''SHA1'', '''+ServerSidNumber+'''+convert(nvarchar(20),MODULID)) where MODULID like '''+LisansliModuller.ModulListesi[I].OzelKod+'%'' ',[],[]);
