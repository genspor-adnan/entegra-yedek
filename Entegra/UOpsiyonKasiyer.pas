...
begin
  ...
  CheckBoxSiparis.Checked := Tablo.GENINI.ReadBoolean(Ops_HizliGiris_SiparisYonu,False); //   HizliGiris', Sipariş
  ...
  ChkYazarkasaKullan.Checked  :=StrToBool(GenRegIni.RegReadString('Yazarkasa','YazarkasaKullanım','0','C'));
  ...
  CheckTahTurAcikHesap.Checked := Tablo.GENINI.ReadBoolean(Ops_StokHizliGiris_TahTurAcikHesap,True); //  StokHizliGiris  TahTur Açık hesap
  ...
  spinAciklamaSatir.EditValue  := Tablo.GENINI.ReadInteger(Ops_OpsiyonKasa_AciklamaSatir, 1);//  Açıklama satır sayısı
...
begin
  ...
  Tablo.GENINI.WriteBoolean(Ops_StokHizliGiris_TahTurAcikHesap,CheckTahTurAcikHesap.Checked); //  StokHizliGiris  TahTur Açık hesap
...
//// Terazi GENINI
   Tablo.GENINI.WriteString(StrToInt(inttoStr(Ops_HizliGiris_TeraziPort)+ ComboTerazi.EditValue),TeraziPort.Text);      ///Bolum+Terazi Değeri eklenir
...
///
  ...
  Tablo.GENINI.WriteBoolean(Ops_HizliGiris_SiparisYonu, CheckBoxSiparis.Checked); //   HizliGiris', Sipariş
  ...
  GenRegIni.RegWriteString('YazarKasa', 'KasaNumarası', CbKasaNumarasi.EditValue, 'C');
  GenRegIni.RegWriteString('YazarKasa', 'KasiyerNumarası', CbKasiyerNumarasi.EditValue, 'C');

  GenRegIni.RegWriteString('YazarKasa', 'BarkodPortNo', CbBarkodPortNo.EditValue, 'C');
  GenRegIni.RegWriteString('YazarKasa', 'BarkodBeklemeZamanı', CbBarkodBekleme.EditValue, 'C');
  ...
  GenRegIni.RegWriteString('Yazarkasa','YazarkasaKullanım',BoolToStr(ChkYazarkasaKullan.Checked),'C');
  //Terazi Ayarları
