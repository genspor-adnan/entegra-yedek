  ...
  object TabSmsEPosta: TFDQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        ',BOYUT='#39#39',LOKASYON='#39#39',GECERLILIK_TARIHI='#39#39',KLASOR='#39#39',EPOSTA AS KAY' +
        'NAK,ANAHTAR,YER  FROM EPOSTALAR'
      'WHERE'
      'REHID=@REHID'
      'UNION ALL'
        ...
        'LOKASYON='#39#39',GECERLILIK_TARIHI='#39#39',KLASOR='#39#39','#39#39' AS KAYNAK ,ANAHTAR,YE' +
        'R  FROM SMSLER'
      'WHERE'
      'REHID=@REHID')
    Left = 200
