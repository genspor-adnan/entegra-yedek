...
type
  TDemirbasDlg = class(TFrame, IIcerikBilgiFrame, IBilgiFrame)
    Panel3: TPanel;
    Bevel1: TBevel;
    Bevel2: TBevel;
    Label24: TLabel;
...
procedure TDemirbasDlg.Baslatildi;
begin

end;

function TDemirbasDlg.EkranAdiAl: string;
begin
  Result := ClassName;
end;

procedure TDemirbasDlg.EkranYazdir(Sender: TObject);
begin

end;

procedure TDemirbasDlg.FareTekerlekAsagi(Sender: TObject;
  Shift: TShiftState; MousePos: TPoint; var Handled: Boolean);
begin

end;

procedure TDemirbasDlg.FareTekerlekYukari(Sender: TObject;
  Shift: TShiftState; MousePos: TPoint; var Handled: Boolean);
begin

end;

function TDemirbasDlg.GetFrameBilgi: TIcerikFrameBilgi;
begin
  Result := FFrameBilgi;
end;

function TDemirbasDlg.GetKapatilabilir: Boolean;
begin

end;

function TDemirbasDlg.GezinmeAktifMi: Boolean;
begin
  Result := True;
end;

procedure TDemirbasDlg.Gorunmez;
begin

end;

procedure TDemirbasDlg.GorunmezOlacak;
begin

end;

procedure TDemirbasDlg.Gorunur;
begin

end;

procedure TDemirbasDlg.GorunurOlacak;
begin

end;

procedure TDemirbasDlg.Kapatiliyor(var AKapansin: Boolean);
begin

end;

procedure TDemirbasDlg.KapatTusClick(Sender: TObject);
begin
  if Assigned(FKapatEylemi) then
    FKapatEylemi(Self);
end;

procedure TDemirbasDlg.SetFrameBilgi(AValue: TIcerikFrameBilgi);
begin
  FFrameBilgi := AValue;
end;

procedure TDemirbasDlg.TusAsagi(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin

end;

procedure TDemirbasDlg.TusBasili(Sender: TObject; var Key: Char);
begin

end;

procedure TDemirbasDlg.TusYukari(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin

end;

function TDemirbasDlg.YazdirmaAktifMi: Boolean;
begin
  Result := False;
end;

procedure TDemirbasDlg.YaziciYazdir(Sender: TObject);
begin

end;

initialization
  RegisterClass(TDemirbasDlg);
end.
