object DemirbasDlg: TDemirbasDlg
  Left = 0
  Top = 0
  Width = 769
  Height = 523
  ...
  object Panel3: TPanel
    ...
    object DBTextKNO: TcxDBTextEdit
      Left = 652
      Top = 155
    ...
    object EditFatTarih: TcxDBTextEdit
      Left = 585
      Top = 77
  ...
  object Panel4: TPanel
    ...
    object ComboAMBARNO: TcxDBComboBox
      Left = 78
      Top = 27
      DataBinding.DataField = 'AMBARNO'
      DataBinding.DataSource = DtsFatBaslik
      Properties.MaxLength = 0
      TabOrder = 1
      Width = 91
    ...
    object DBComboBox2: TcxDBComboBox
      Left = 78
      Top = 48
    ...
    object DBEdit8: TcxDBTextEdit
      Left = 78
      Top = 6
      DataBinding.DataField = 'SATICIKODU'
      DataBinding.DataSource = DtsFatBaslik
      TabOrder = 6
      Width = 90
    end
    ...
    object ComboFatKur: TcxDBComboBox
      Left = 633
      Top = 48
    ...
    object DOVIZ_TUTARI: TcxDBTextEdit
      Left = 78
      Top = 70
    ...
    object ComboDovizKur: TcxDBComboBox
      Left = 130
      Top = 70
  ...
  object PopupMenuFatura: TPopupMenu
    ...
    object FaturaIptalIsaretle: TMenuItem
      Caption = 'Bu Faturay'#305' "'#304'ptal" '#304#351'aretle'
    end
  ...
  object TabDemirbasDetay: TFDQuery
  ...
  object TabDemirbas: TFDQuery
    ...
    SQL.Strings = (
      'select *,'
      'YAZIYLATOPLAM=(SELECt dbo.fn_MoneyToText(FATURA_TUTARI))'
      ''
      ' from FATBASLIK where TUR= :Par')
    Left = 681
    Top = 216
  end
