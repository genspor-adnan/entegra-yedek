...
type
  ...
  public
    { Public declarations }
    FAltTur : SmallInt;    //AltTur: MasrafKalemleri:3,Sorumluluk Merkezleri:4,DağıtımAnahtarı:5
  published
...
begin
  ...
  if not Tablo.YetkiVarmi(2313,YetkiTur_Gorme) then begin
      ...
      ListelerMenuGider.Categories[0].items[1].Free; //Dağıtım
      ListelerMenuGelir.Categories[0].items[2].Free; //
      ListelerMenuGelir.Categories[0].items[1].Free; //Dağıtım
  end;
