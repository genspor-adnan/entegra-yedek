...
begin
  {Burası Talimat Çağırma bölümü idi
...
begin
  with FFrameBilgi.IcerikGit(TCekListeFrame).Ornek as TCekListeFrame do begin
    ...
    Arama.SheetAlinanCekler.Caption := 'Alınan '+CekTurAd+'ler';
    Arama.SheetVerilenCekler.Caption := 'Verilen '+CekTurAd+'ler';
    SheetHesapListe.Caption := CekTurAd+' Hesapları';

    case CekTur of
     130 : begin  //alınan çek / senet
