...
uses InvokeRegistry, SOAPHTTPClient, Types, XSBuiltIns,Windows;
...
begin
  ...
  defWSDL := 'http://'+Addr+'/genlisans/lisansws.asmx?WSDL';
  defURL := 'http://'+Addr+'/genlisans/lisansws.asmx';
