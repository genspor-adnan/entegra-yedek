...
begin
  { Panel1.Caption arka tarafta olduğu için yazılan yazıda görünmüyor ve çirkin bir görüntü meydana getiriyor }
//  Panel1.Caption := TabloDokum.TabDokum.FieldByName('RAPORADI').AsString + ' Döküm Ayarları';
...
begin
  if Application.MessageBox(PChar(SSilmeSorusu), PChar(SGenotipOnay), MB_YESNO) = IDYES then
     //Veritabani.BasitKomutÇalıştır(Tablo.FDCnn, ' delete from REHBERINI where BOLUM=''&kod''',['&kod'],
