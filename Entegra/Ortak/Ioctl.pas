...
function DoReadAttributesCmd( hDevice : THandle; SCIP : TSendCmdInParams; var SCOP : TSendCmdOutParams;	bDriveNum : Byte ) : BOOL;
...
begin
	...
	Result := DeviceIoControl( hDevice, DFP_RECEIVE_DRIVE_DATA, @SCIP, SizeOf(TSendCmdInParams)-1,
							@SCOP, SizeOf(TSendCmdOutParams)+READ_ATTRIBUTE_BUFFER_SIZE-1, dwBytesReturned, nil );
end;
//-------------------------------------------------------------
// DoReadThresholdsCmd
//
...
//
function DoReadThresholdsCmd( hDevice : THandle; SCIP : TSendCmdInParams; var SCOP : TSendCmdOutParams;	bDriveNum : Byte ) : BOOL;
var dwBytesReturned : DWORD;
begin
	...
	Result := DeviceIoControl( hDevice, DFP_RECEIVE_DRIVE_DATA, @SCIP, SizeOf(TSendCmdInParams)-1,
							@SCOP, SizeOf(TSendCmdOutParams)+READ_THRESHOLD_BUFFER_SIZE-1, dwBytesReturned, nil );
end;
//---------------------------------------------------------------------
// Change the WORD array to a BYTE array
//---------------------------------------------------------------------
