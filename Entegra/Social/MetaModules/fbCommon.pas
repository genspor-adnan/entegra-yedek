...
var
  ...
  { WITH PAGE ACCESS TOKEN
    me?fields=business    İşletme hesabı
    me?fields=about       Sayfa Hakkında bilgi
  ...
  ----------------------------------------
    ...
    Logix Yazılım        193888073799204  facebook.com/logixyazilim
  ...
  1569153207222534		Granit'(n)in 2 Aralık 2023 Cumartesi 14:31 tarihinde oluşturduğu form
  ...
  2184820375186596		İletişim formu oluşturma zamanı: 12/02/2023 9:05:10
...
const
   ...
   constComboPages : array[0..cFacebookPageCount-1] of recPage =(
     ...
     //,(pageName: 'Logix Yazılım'; pageId : '193888073799204'{; pageToken : 'EAAJFC5NMtMcBO84wgp6ydDSH9gkVwTBER6Lzi0jbllb4NgIqB6d8BZBTc7tt4CSjrRcg3pRDRZACjx8gJZCCSH7dAZACSMDBFDdZCZCjW5HUYHKQGeAheWQnbwW5U4pvaVV4FFzDpJteIcc69taAvQ5EDaK7ar7n9IZACqGZA1TkEF4JiqiXF0QEZAj7FzpscuTEtalpnZBg32l1OchBwZD'})
   );
