...
begin
  Tablo.ListedenDuzenle(Tablo.FDCnn,'Amortisman Oranları','SELECT KOD,ACIKLAMA,YIL,ORAN,TEBLIG FROM AMORTISMAN_ORAN','Amortisman',True,False,True);
end;
...
begin
  if DtsAksiyonDurum.State=dsEdit then
   ...
   Tablo.GENINI.WriteInteger(Ops_OpsiyonDemirbas_VarsayilanKlasor,VarsayilanKlasor.Tag);//  OpsiyonDemirbaş  VarsayilanKlasor Dokuman için
