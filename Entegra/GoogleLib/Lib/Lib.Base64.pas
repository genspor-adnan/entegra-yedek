...
function Base64Encode(const AData: Pointer; const ASize: Integer): TBytes; overload;
...
{ Encodes binary data to a Base64 buffer.
  ...
  Returns:
    A byte array containing the Base64 encoded data }
function Base64Encode(const AData: TBytes): TBytes; overload; inline;
...
function Base64Decode(const AData: Pointer; const ASize: Integer): TBytes; overload;
...
{ Decodes Base64-encoded binary data.
  ...
  Returns:
    A byte array containing the decoded binary data data }
function Base64Decode(const AData: TBytes): TBytes; overload; inline;
