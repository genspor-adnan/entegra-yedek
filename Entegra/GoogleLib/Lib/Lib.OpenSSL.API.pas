...
var
  ...
  PEM_write_bio_PKCS8PrivateKey: function(bp: PBIO; x: PEVP_PKEY; enc: PEVP_CIPHER; kstr: PAnsiChar;
            klen: Longint; cb: TPemPasswordCallback; u: pointer): LongInt; cdecl = nil;
  ...
  d2i_PKCS12_bio: function(bp: PBIO; x: PPKCS12): PKCS12 cdecl = nil;
  PKCS12_parse: function(P12: PKCS12; Password: PAnsiChar; out PrivateKey: PEVP_PKEY; out Cert: PX509; CertChain: PPSTACK_OF_X509): Integer cdecl = nil;
...
begin
  ...
  sk_pop_free := GetProc(_LIBEAYHandle, 'sk_pop_free');
  ...
  PEM_write_bio_PKCS8PrivateKey := GetProc(_LIBEAYHandle, 'PEM_write_bio_PKCS8PrivateKey');
  HMAC := GetProc(_LIBEAYHandle, 'HMAC');
  d2i_PKCS12_bio := GetProc(_LIBEAYHandle, 'd2i_PKCS12_bio');
  PKCS12_parse := GetProc(_LIBEAYHandle, 'PKCS12_parse');
  PKCS12_new := GetProc(_LIBEAYHandle, 'PKCS12_new');
  PKCS12_free := GetProc(_LIBEAYHandle, 'PKCS12_free');
end;
