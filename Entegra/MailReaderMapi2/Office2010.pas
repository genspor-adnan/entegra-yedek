...
// $Rev: 40264 $
// File generated on 6/9/2011 10:37:19 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: c:\Program Files\Common Files\microsoft shared\OFFICE14\mso.dll (1)
// LIBID: {2DF8D04C-5BFA-101B-BDE5-00AA0044DE52}
// LCID: 0
// Helpfile: c:\Program Files\Common Files\microsoft shared\OFFICE14\vbaof11.chm
...
//   Error creating palette bitmap of (TCustomXMLSchemaCollection) : Range check error
//   Error creating palette bitmap of (TCustomXMLPart) : Range check error
//   Error creating palette bitmap of (TCustomXMLParts) : Range check error
//   Error creating palette bitmap of (TCustomTaskPane) : Range check error
// Cmdline:
//   tlibimp  -Fe2010 -Ha- -Hs+ -Hr+ -Yp+ -HpsOfficeXP -P+ "c:\Program Files\Common Files\microsoft shared\OFFICE14\mso.dll"
// ************************************************************************ //
...
// *********************************************************************//
  COMAddIns = interface(_IMsoDispObj)
    ...
    function Item(const Index: OleVariant): COMAddIn; safecall;
    function Get_Count: Integer; safecall;
    function Get__NewEnum: IUnknown; safecall;
...
// *********************************************************************//
  COMAddInsDisp = dispinterface
    ['{000C0339-0000-0000-C000-000000000046}']
    function Item(const Index: OleVariant): COMAddIn; dispid 0;
...
// *********************************************************************//
  HTMLProjectItems = interface(_IMsoDispObj)
    ...
    function Item(const Index: OleVariant): HTMLProjectItem; safecall;
    function Get_Count: Integer; safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Get_Parent: IDispatch; safecall;
    property Count: Integer read Get_Count;
...
// *********************************************************************//
  HTMLProjectItemsDisp = dispinterface
    ['{000C0357-0000-0000-C000-000000000046}']
    function Item(const Index: OleVariant): HTMLProjectItem; dispid 0;
    property Count: Integer readonly dispid 1;
    property _NewEnum: IUnknown readonly dispid -4;
...
// *********************************************************************//
  ILicWizExternal = interface(IDispatch)
    ...
    procedure ShowHelp(const pvarId: OleVariant); safecall;
...
// *********************************************************************//
  ILicWizExternalDisp = dispinterface
    ...
    procedure ShowHelp(const pvarId: OleVariant); dispid 4;
...
// *********************************************************************//
  SignatureProviderDisp = dispinterface
    ...
    function HashStream(const QueryContinue: IUnknown; const Stream: IUnknown): {NOT_OLEAUTO(PSafeArray)}OleVariant; dispid 1610743816;
  end;
...
// *********************************************************************//
  IMsoChart = interface(IDispatch)
    ...
    function Get_ChartGroups(const pvarIndex: OleVariant; varIgallery: OleVariant; lcid: Integer): IDispatch; safecall;
    ...
    property ChartGroups[const pvarIndex: OleVariant; varIgallery: OleVariant; lcid: Integer]: IDispatch read Get_ChartGroups;
...
// *********************************************************************//
  IMsoChartDisp = dispinterface
    ...
    property ChartGroups[const pvarIndex: OleVariant; varIgallery: OleVariant; lcid: Integer]: IDispatch readonly dispid 8;
...
// *********************************************************************//
  IBlogExtensibilityDisp = dispinterface
    ...
    procedure GetUserBlogs(const Account: WideString; ParentWindow: Integer; 
                           ...
                           out BlogNames: {NOT_OLEAUTO(PSafeArray)}OleVariant; 
                           out BlogIDs: {NOT_OLEAUTO(PSafeArray)}OleVariant; 
                           out BlogURLs: {NOT_OLEAUTO(PSafeArray)}OleVariant); dispid 3;
    procedure GetRecentPosts(const Account: WideString; ParentWindow: Integer; 
                             const Document: IDispatch; 
                             out PostTitles: {NOT_OLEAUTO(PSafeArray)}OleVariant; 
                             out PostDates: {NOT_OLEAUTO(PSafeArray)}OleVariant; 
                             out PostIDs: {NOT_OLEAUTO(PSafeArray)}OleVariant); dispid 4;
    procedure Open(const Account: WideString; const PostID: WideString; ParentWindow: Integer; 
                   out xHTML: WideString; out Title: WideString; out DatePosted: WideString; 
                   out Categories: {NOT_OLEAUTO(PSafeArray)}OleVariant); dispid 5;
    procedure PublishPost(const Account: WideString; ParentWindow: Integer; 
                          const Document: IDispatch; const xHTML: WideString; 
                          const Title: WideString; const DateTime: WideString; 
                          Categories: {NOT_OLEAUTO(PSafeArray)}OleVariant; Draft: WordBool; 
    ...
    procedure RepublishPost(const Account: WideString; ParentWindow: Integer; 
                            ...
                            Categories: {NOT_OLEAUTO(PSafeArray)}OleVariant; Draft: WordBool; 
                            out PublishMessage: WideString); dispid 7;
    procedure GetCategories(const Account: WideString; ParentWindow: Integer; 
                            const Document: IDispatch; 
                            out Categories: {NOT_OLEAUTO(PSafeArray)}OleVariant); dispid 8;
  end;
...
// Server Object    : TCustomXMLSchemaCollection
// Help String      : 
...
// *********************************************************************//
  TCustomXMLSchemaCollection = class(TOleServer)
  private
    FIntf: _CustomXMLSchemaCollection;
    function GetDefaultInterface: _CustomXMLSchemaCollection;
  protected
    procedure InitServerData; override;
    function Get_Parent: IDispatch;
    function Get_Count: Integer;
    function Get_Item(Index: OleVariant): CustomXMLSchema;
  ...
  public
    ...
    procedure ConnectTo(svrIntf: _CustomXMLSchemaCollection);
    procedure Disconnect; override;
    function Add(const NamespaceURI: WideString; const Alias: WideString; 
                 const FileName: WideString; InstallForAllUsers: WordBool): CustomXMLSchema;
    procedure AddCollection(const SchemaCollection: CustomXMLSchemaCollection);
    function Validate: WordBool;
    property DefaultInterface: _CustomXMLSchemaCollection read GetDefaultInterface;
    property Parent: IDispatch read Get_Parent;
    property Count: Integer read Get_Count;
    property Item[Index: OleVariant]: CustomXMLSchema read Get_Item; default;
    property NamespaceURI[Index: Integer]: WideString read Get_NamespaceURI;
...
// *********************************************************************//
  ...
  TCustomXMLPartNodeAfterInsert = procedure(ASender: TObject; const NewNode: CustomXMLNode; 
                                                              InUndoRedo: WordBool) of object;
  TCustomXMLPartNodeAfterDelete = procedure(ASender: TObject; const OldNode: CustomXMLNode; 
                                                              const OldParentNode: CustomXMLNode; 
                                                              const OldNextSibling: CustomXMLNode; 
                                                              InUndoRedo: WordBool) of object;
  TCustomXMLPartNodeAfterReplace = procedure(ASender: TObject; const OldNode: CustomXMLNode; 
                                                               const NewNode: CustomXMLNode; 
                                                               InUndoRedo: WordBool) of object;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TCustomXMLPart
// Help String      : 
// Default Interface: _CustomXMLPart
// Def. Intf. DISP? : No
// Event   Interface: _CustomXMLPartEvents
// TypeFlags        : (0)
// *********************************************************************//
  TCustomXMLPart = class(TOleServer)
  private
    FOnNodeAfterInsert: TCustomXMLPartNodeAfterInsert;
    FOnNodeAfterDelete: TCustomXMLPartNodeAfterDelete;
    FOnNodeAfterReplace: TCustomXMLPartNodeAfterReplace;
    FIntf: _CustomXMLPart;
    function GetDefaultInterface: _CustomXMLPart;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_Parent: IDispatch;
    function Get_DocumentElement: CustomXMLNode;
    function Get_Id: WideString;
    function Get_NamespaceURI: WideString;
    function Get_SchemaCollection: CustomXMLSchemaCollection;
    procedure Set_SchemaCollection(const ppSchemaCollection: CustomXMLSchemaCollection);
    function Get_NamespaceManager: CustomXMLPrefixMappings;
    function Get_XML: WideString;
    function Get_Errors: CustomXMLValidationErrors;
    function Get_BuiltIn: WordBool;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: _CustomXMLPart);
    procedure Disconnect; override;
    procedure AddNode(const Parent: CustomXMLNode; const Name: WideString; 
                      const NamespaceURI: WideString; const NextSibling: CustomXMLNode; 
                      NodeType: MsoCustomXMLNodeType; const NodeValue: WideString);
    procedure Delete;
    function Load(const FilePath: WideString): WordBool;
    function LoadXML(const XML: WideString): WordBool;
    function SelectNodes(const XPath: WideString): CustomXMLNodes;
    function SelectSingleNode(const XPath: WideString): CustomXMLNode;
    property DefaultInterface: _CustomXMLPart read GetDefaultInterface;
    property Parent: IDispatch read Get_Parent;
    property DocumentElement: CustomXMLNode read Get_DocumentElement;
    property Id: WideString read Get_Id;
    property NamespaceURI: WideString read Get_NamespaceURI;
    ...
    property SchemaCollection: CustomXMLSchemaCollection read Get_SchemaCollection write Set_SchemaCollection;
  published
    property OnNodeAfterInsert: TCustomXMLPartNodeAfterInsert read FOnNodeAfterInsert write FOnNodeAfterInsert;
    property OnNodeAfterDelete: TCustomXMLPartNodeAfterDelete read FOnNodeAfterDelete write FOnNodeAfterDelete;
    property OnNodeAfterReplace: TCustomXMLPartNodeAfterReplace read FOnNodeAfterReplace write FOnNodeAfterReplace;
  end;
...
// *********************************************************************//
  ...
  TCustomXMLPartsPartAfterAdd = procedure(ASender: TObject; const NewPart: CustomXMLPart) of object;
  TCustomXMLPartsPartBeforeDelete = procedure(ASender: TObject; const OldPart: CustomXMLPart) of object;
  TCustomXMLPartsPartAfterLoad = procedure(ASender: TObject; const Part: CustomXMLPart) of object;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TCustomXMLParts
// Help String      : 
// Default Interface: _CustomXMLParts
// Def. Intf. DISP? : No
// Event   Interface: _CustomXMLPartsEvents
// TypeFlags        : (0)
// *********************************************************************//
  TCustomXMLParts = class(TOleServer)
  private
    FOnPartAfterAdd: TCustomXMLPartsPartAfterAdd;
    FOnPartBeforeDelete: TCustomXMLPartsPartBeforeDelete;
    FOnPartAfterLoad: TCustomXMLPartsPartAfterLoad;
    FIntf: _CustomXMLParts;
    function GetDefaultInterface: _CustomXMLParts;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_Parent: IDispatch;
    function Get_Count: Integer;
    function Get_Item(Index: OleVariant): CustomXMLPart;
    function Get__NewEnum: IUnknown;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: _CustomXMLParts);
    procedure Disconnect; override;
    function Add(const XML: WideString): CustomXMLPart; overload;
    function Add(const XML: WideString; SchemaCollection: OleVariant): CustomXMLPart; overload;
    function SelectByID(const Id: WideString): CustomXMLPart;
    function SelectByNamespace(const NamespaceURI: WideString): CustomXMLParts;
    property DefaultInterface: _CustomXMLParts read GetDefaultInterface;
    property Parent: IDispatch read Get_Parent;
    property Count: Integer read Get_Count;
    property Item[Index: OleVariant]: CustomXMLPart read Get_Item; default;
    property _NewEnum: IUnknown read Get__NewEnum;
  published
    property OnPartAfterAdd: TCustomXMLPartsPartAfterAdd read FOnPartAfterAdd write FOnPartAfterAdd;
    property OnPartBeforeDelete: TCustomXMLPartsPartBeforeDelete read FOnPartBeforeDelete write FOnPartBeforeDelete;
    property OnPartAfterLoad: TCustomXMLPartsPartAfterLoad read FOnPartAfterLoad write FOnPartAfterLoad;
  end;
...
// *********************************************************************//
  ...
  TCustomTaskPaneVisibleStateChange = procedure(ASender: TObject; const CustomTaskPaneInst: _CustomTaskPane) of object;
  TCustomTaskPaneDockPositionStateChange = procedure(ASender: TObject; const CustomTaskPaneInst: _CustomTaskPane) of object;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TCustomTaskPane
// Help String      : 
// Default Interface: _CustomTaskPane
// Def. Intf. DISP? : No
// Event   Interface: _CustomTaskPaneEvents
// TypeFlags        : (0)
// *********************************************************************//
  TCustomTaskPane = class(TOleServer)
  private
    FOnVisibleStateChange: TCustomTaskPaneVisibleStateChange;
    FOnDockPositionStateChange: TCustomTaskPaneDockPositionStateChange;
  ...
  protected
    ...
    function Get_Window: IDispatch;
    function Get_Visible: WordBool;
    procedure Set_Visible(prop: WordBool);
    function Get_ContentControl: IDispatch;
    function Get_Height: SYSINT;
    procedure Set_Height(prop: SYSINT);
    function Get_Width: SYSINT;
    procedure Set_Width(prop: SYSINT);
    function Get_DockPosition: MsoCTPDockPosition;
    procedure Set_DockPosition(prop: MsoCTPDockPosition);
    function Get_DockPositionRestrict: MsoCTPDockPositionRestrict;
    procedure Set_DockPositionRestrict(prop: MsoCTPDockPositionRestrict);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    ...
    property DockPositionRestrict: MsoCTPDockPositionRestrict read Get_DockPositionRestrict write Set_DockPositionRestrict;
  published
    property OnVisibleStateChange: TCustomTaskPaneVisibleStateChange read FOnVisibleStateChange write FOnVisibleStateChange;
    property OnDockPositionStateChange: TCustomTaskPaneDockPositionStateChange read FOnDockPositionStateChange write FOnDockPositionStateChange;
  end;

procedure Register;

resourcestring
  dtlServerPage = 'OfficeXP';
...
procedure TCustomXMLSchemaCollection.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{000CDB0D-0000-0000-C000-000000000046}';
    IntfIID:   '{000CDB02-0000-0000-C000-000000000046}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TCustomXMLSchemaCollection.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as _CustomXMLSchemaCollection;
  end;
end;

procedure TCustomXMLSchemaCollection.ConnectTo(svrIntf: _CustomXMLSchemaCollection);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TCustomXMLSchemaCollection.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TCustomXMLSchemaCollection.GetDefaultInterface: _CustomXMLSchemaCollection;
begin
  if FIntf = nil then
    Connect;
...
constructor TCustomXMLSchemaCollection.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TCustomXMLSchemaCollection.Destroy;
begin
  inherited Destroy;
end;

function TCustomXMLSchemaCollection.Get_Parent: IDispatch;
begin
    Result := DefaultInterface.Parent;
end;

function TCustomXMLSchemaCollection.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TCustomXMLSchemaCollection.Get_Item(Index: OleVariant): CustomXMLSchema;
begin
    Result := DefaultInterface.Item[Index];
end;

function TCustomXMLSchemaCollection.Get_NamespaceURI(Index: Integer): WideString;
begin
    Result := DefaultInterface.NamespaceURI[Index];
end;

function TCustomXMLSchemaCollection.Get__NewEnum: IUnknown;
begin
    Result := DefaultInterface._NewEnum;
end;

function TCustomXMLSchemaCollection.Add(const NamespaceURI: WideString; const Alias: WideString; 
                                        const FileName: WideString; InstallForAllUsers: WordBool): CustomXMLSchema;
begin
  Result := DefaultInterface.Add(NamespaceURI, Alias, FileName, InstallForAllUsers);
end;

procedure TCustomXMLSchemaCollection.AddCollection(const SchemaCollection: CustomXMLSchemaCollection);
begin
  DefaultInterface.AddCollection(SchemaCollection);
end;

function TCustomXMLSchemaCollection.Validate: WordBool;
begin
...
procedure TCustomXMLPart.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{000CDB08-0000-0000-C000-000000000046}';
    IntfIID:   '{000CDB05-0000-0000-C000-000000000046}';
    EventIID:  '{000CDB07-0000-0000-C000-000000000046}';
    LicenseKey: nil;
    Version: 500);
begin
  ServerData := @CServerData;
...
procedure TCustomXMLPart.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as _CustomXMLPart;
  end;
end;

procedure TCustomXMLPart.ConnectTo(svrIntf: _CustomXMLPart);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
procedure TCustomXMLPart.DisConnect;
begin
  if Fintf <> nil then
  begin
...
function TCustomXMLPart.GetDefaultInterface: _CustomXMLPart;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TCustomXMLPart.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TCustomXMLPart.Destroy;
begin
  inherited Destroy;
end;

procedure TCustomXMLPart.InvokeEvent(DispID: TDispID; var Params: TVariantArray);
begin
  case DispID of
    -1: Exit;  // DISPID_UNKNOWN
    1: if Assigned(FOnNodeAfterInsert) then
         FOnNodeAfterInsert(Self,
                            IUnknown(TVarData(Params[0]).VPointer) as CustomXMLNode {const CustomXMLNode},
                            Params[1] {WordBool});
    2: if Assigned(FOnNodeAfterDelete) then
         FOnNodeAfterDelete(Self,
                            IUnknown(TVarData(Params[0]).VPointer) as CustomXMLNode {const CustomXMLNode},
                            IUnknown(TVarData(Params[1]).VPointer) as CustomXMLNode {const CustomXMLNode},
                            IUnknown(TVarData(Params[2]).VPointer) as CustomXMLNode {const CustomXMLNode},
                            Params[3] {WordBool});
    3: if Assigned(FOnNodeAfterReplace) then
         FOnNodeAfterReplace(Self,
                             IUnknown(TVarData(Params[0]).VPointer) as CustomXMLNode {const CustomXMLNode},
                             IUnknown(TVarData(Params[1]).VPointer) as CustomXMLNode {const CustomXMLNode},
                             Params[2] {WordBool});
  end; {case DispID}
...
function TCustomXMLPart.Get_Parent: IDispatch;
begin
    Result := DefaultInterface.Parent;
end;

function TCustomXMLPart.Get_DocumentElement: CustomXMLNode;
begin
    Result := DefaultInterface.DocumentElement;
end;

function TCustomXMLPart.Get_Id: WideString;
begin
    Result := DefaultInterface.Id;
end;

function TCustomXMLPart.Get_NamespaceURI: WideString;
begin
    Result := DefaultInterface.NamespaceURI;
end;

function TCustomXMLPart.Get_SchemaCollection: CustomXMLSchemaCollection;
begin
    Result := DefaultInterface.SchemaCollection;
end;

procedure TCustomXMLPart.Set_SchemaCollection(const ppSchemaCollection: CustomXMLSchemaCollection);
begin
  DefaultInterface.Set_SchemaCollection(ppSchemaCollection);
end;

function TCustomXMLPart.Get_NamespaceManager: CustomXMLPrefixMappings;
begin
    Result := DefaultInterface.NamespaceManager;
end;

function TCustomXMLPart.Get_XML: WideString;
begin
    Result := DefaultInterface.XML;
end;

function TCustomXMLPart.Get_Errors: CustomXMLValidationErrors;
begin
    Result := DefaultInterface.Errors;
end;

function TCustomXMLPart.Get_BuiltIn: WordBool;
begin
    Result := DefaultInterface.BuiltIn;
end;

procedure TCustomXMLPart.AddNode(const Parent: CustomXMLNode; const Name: WideString; 
                                 const NamespaceURI: WideString; const NextSibling: CustomXMLNode; 
                                 NodeType: MsoCustomXMLNodeType; const NodeValue: WideString);
begin
  DefaultInterface.AddNode(Parent, Name, NamespaceURI, NextSibling, NodeType, NodeValue);
end;

procedure TCustomXMLPart.Delete;
begin
  DefaultInterface.Delete;
end;

function TCustomXMLPart.Load(const FilePath: WideString): WordBool;
begin
  Result := DefaultInterface.Load(FilePath);
end;

function TCustomXMLPart.LoadXML(const XML: WideString): WordBool;
begin
  Result := DefaultInterface.LoadXML(XML);
end;

function TCustomXMLPart.SelectNodes(const XPath: WideString): CustomXMLNodes;
begin
  Result := DefaultInterface.SelectNodes(XPath);
end;

function TCustomXMLPart.SelectSingleNode(const XPath: WideString): CustomXMLNode;
begin
  Result := DefaultInterface.SelectSingleNode(XPath);
end;
...
procedure TCustomXMLParts.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{000CDB0C-0000-0000-C000-000000000046}';
    IntfIID:   '{000CDB09-0000-0000-C000-000000000046}';
    EventIID:  '{000CDB0B-0000-0000-C000-000000000046}';
    LicenseKey: nil;
    Version: 500);
begin
  ServerData := @CServerData;
...
procedure TCustomXMLParts.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as _CustomXMLParts;
  end;
end;

procedure TCustomXMLParts.ConnectTo(svrIntf: _CustomXMLParts);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
procedure TCustomXMLParts.DisConnect;
begin
  if Fintf <> nil then
  begin
    DisconnectEvents(FIntf);
...
function TCustomXMLParts.GetDefaultInterface: _CustomXMLParts;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TCustomXMLParts.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TCustomXMLParts.Destroy;
begin
  inherited Destroy;
end;

procedure TCustomXMLParts.InvokeEvent(DispID: TDispID; var Params: TVariantArray);
begin
  case DispID of
    -1: Exit;  // DISPID_UNKNOWN
    1: if Assigned(FOnPartAfterAdd) then
         FOnPartAfterAdd(Self, IUnknown(TVarData(Params[0]).VPointer) as CustomXMLPart {const CustomXMLPart});
    2: if Assigned(FOnPartBeforeDelete) then
         FOnPartBeforeDelete(Self, IUnknown(TVarData(Params[0]).VPointer) as CustomXMLPart {const CustomXMLPart});
    3: if Assigned(FOnPartAfterLoad) then
         FOnPartAfterLoad(Self, IUnknown(TVarData(Params[0]).VPointer) as CustomXMLPart {const CustomXMLPart});
  end; {case DispID}
end;

function TCustomXMLParts.Get_Parent: IDispatch;
begin
    Result := DefaultInterface.Parent;
end;

function TCustomXMLParts.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TCustomXMLParts.Get_Item(Index: OleVariant): CustomXMLPart;
begin
    Result := DefaultInterface.Item[Index];
end;

function TCustomXMLParts.Get__NewEnum: IUnknown;
begin
    Result := DefaultInterface._NewEnum;
end;

function TCustomXMLParts.Add(const XML: WideString): CustomXMLPart;
var
  EmptyParam: OleVariant;
begin
  EmptyParam := Variants.EmptyParam;
  Result := DefaultInterface.Add(XML, EmptyParam);
end;

function TCustomXMLParts.Add(const XML: WideString; SchemaCollection: OleVariant): CustomXMLPart;
begin
  Result := DefaultInterface.Add(XML, SchemaCollection);
end;

function TCustomXMLParts.SelectByID(const Id: WideString): CustomXMLPart;
begin
  Result := DefaultInterface.SelectByID(Id);
end;

function TCustomXMLParts.SelectByNamespace(const NamespaceURI: WideString): CustomXMLParts;
begin
  Result := DefaultInterface.SelectByNamespace(NamespaceURI);
end;
...
begin
  DefaultInterface.Set_Visible(prop);
end;
...
begin
  DefaultInterface.Set_Height(prop);
end;
...
begin
  DefaultInterface.Set_Width(prop);
end;
...
begin
  DefaultInterface.Set_DockPosition(prop);
end;
...
begin
  DefaultInterface.Set_DockPositionRestrict(prop);
end;
