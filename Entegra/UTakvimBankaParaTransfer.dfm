object TakvimBankaParaTransferDLG: TTakvimBankaParaTransferDLG
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  Caption = 'Para Transferi (Gelen)'
  ClientHeight = 566
  ClientWidth = 785
  ...
  object JvPanel4: TJvPanel
    ...
    object LabelGonAd: TcxDBLabel
      ...
      DataBinding.DataSource = DtsMusteriBilgileri
      Transparent = True
      Height = 21
      Width = 555
    end
  ...
  object JvPanel18: TJvPanel
    ...
    object LabelAlAd: TcxDBLabel
      ...
      Anchors = [akLeft, akTop, akRight]
      DataBinding.DataField = 'FIRMA'
      DataBinding.DataSource = DtsBizimBilgiler
      Transparent = True
      Height = 21
      Width = 555
    end
  ...
  object JvPanel5: TJvPanel
    ...
    object LabelDovizTutari: TcxLabel
      Left = 104
      Top = 3
    end
    object LabelDovizKuru: TcxLabel
      Left = 107
      Top = 3
    end
  end
  ...
  object JvPanel2: TJvPanel
    ...
    DesignSize = (
      572
      25)
    object ComboOdemeKanali: TcxImageComboBox
      Left = 2
      Top = 2
      Anchors = [akLeft, akTop, akRight]
      ParentColor = True
      Properties.Items = <>
      Properties.OnChange = ComboOdemeKanaliPropertiesEditValueChanged
      Style.BorderStyle = ebsNone
      Style.TransparentBorder = True
  ...
  object ImageGon: TJvDBImage
    ...
    Color = clBtnFace
    DataField = 'LOGO'
    DataSource = DtsMusteriBilgileri
    Font.Charset = TURKISH_CHARSET
    Font.Color = clHighlightText
    Font.Height = -1
    Font.Name = 'Trebuchet MS'
  ...
  object TabMusteriBilgileri: TFDQuery
    Connection = Tablo.FDCnn
    ParamData = <
      item
        Name = 'PMusteriHesapID'
        Size = -1
        Value = Null
      end
      item
    ...
    SQL.Strings = (
      ...
      'BBH.HESAPNO,'
        ...
        'VERGINO=(SELECT BILGI FROM REHBERAYAR RA INNER JOIN REHBERBILGI ' +
        'RB ON RA.SIRA=RB.SIRA AND RA.YERI=RB.YERI WHERE RB.YER_ID=BR.ID ' +
        'AND RA.VARSAYILAN=22),'
      
        'LOGO= (SELECT BELGE FROM IMAJ I WHERE VARSAYILAN=1 AND YERI=11 A' +
        'ND YER_ID=BR.ID )  '
      'FROM '
      '  --M'#252#351'teri Bilgileri'
      '  REHBER BR LEFT OUTER JOIN'
      '  BANKAHESAPLAR BBH ON '
      '    BBH.ID=:PMusteriHesapID LEFT OUTER JOIN'
      '  BANKASUBELER BS ON'
      '    BS.ID=BBH.BANKASUBELERID  LEFT OUTER JOIN'
      '  BANKALAR BB ON'
      '    BS.BANKAKODU=BB.BANKAKODU '
      'WHERE BR.ID=:PRehberID')
    Left = 165
    Top = 503
  end
  object DtsMusteriBilgileri: TDataSource
    DataSet = TabMusteriBilgileri
    Left = 170
    Top = 442
  end
  object TabBizimBilgiler: TFDQuery
    Connection = Tablo.FDCnn
    ParamData = <
      item
        Name = 'PBankaHesaplarID'
    ...
    SQL.Strings = (
      ...
      #9'KREDIKARTI KK ON'
      #9#9'KK.ID=:PKrediKartiID LEFT OUTER JOIN '
  ...
  object DtsBizimBilgiler: TDataSource
    DataSet = TabBizimBilgiler
    Left = 105
    Top = 440
  end
