...
begin
   //Efektif faiz oranı bulma formülü :  r = [ (1+i/n)^n ] - 1,  i:nominalfaiz  n:period
...
{       if EditBSMVOrani.Text <> '' then
   ...
   begin
       ...
       s:='  SET @TAKSITSAY='+IntToStr(TAKSITSay.Value)+
        ...
        ' SET @DONEM = '+ IntToStr(RadioGroupDonem.ItemIndex)+               //  0 : dönembaşı, 1: dönem sonu
...
begin
   //sqlde hata çıkıyor virgülü nokta yapalım
