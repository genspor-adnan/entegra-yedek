...
// $Rev: 40264 $
// File generated on 6/9/2011 10:37:15 PM from Type Library described below.
...
//   Error creating palette bitmap of (TPowerPointApplication) : Range check error
// Cmdline:
//   tlibimp  -Fe2010 -Ha- -Hs+ -Hr+ -Yp+ -HpsOfficeXP -P+ "c:\Program Files\Microsoft Office\Office14\msppt.olb"
// ************************************************************************ //
...
uses Windows, ActiveX, Classes, Graphics, Office2010, OleServer, StdVCL, Variants, 
VBIDE2010;
...
// *********************************************************************//
  _Application = interface(IDispatch)
    ...
    procedure LaunchSendToPPTDialog(const SlideUrls: OleVariant); safecall;
...
// *********************************************************************//
  _ApplicationDisp = dispinterface
    ...
    function Run(const MacroName: WideString; 
                 var safeArrayOfParams: {NOT_OLEAUTO(PSafeArray)}OleVariant): OleVariant; dispid 2022;
    ...
    procedure LaunchSendToPPTDialog(const SlideUrls: OleVariant); dispid 2055;
    ...
    property ResampleMediaTasks: ResampleMediaTasks readonly dispid 2066;
    procedure StartNewUndoEntry; dispid 2067;
    property FileValidation: MsoFileValidationMode dispid 2068;
  end;
...
// *********************************************************************//
  AddIns = interface(Collection)
    ...
    function Get_Application: PowerPointApplication; safecall;
    function Get_Parent: IDispatch; safecall;
    function Item(const Index: OleVariant): AddIn; safecall;
    function Add(const FileName: WideString): AddIn; safecall;
    procedure Remove(const Index: OleVariant); safecall;
    property Application: PowerPointApplication read Get_Application;
    property Parent: IDispatch read Get_Parent;
  end;
...
// *********************************************************************//
  AddInsDisp = dispinterface
    ...
    property Application: PowerPointApplication readonly dispid 2001;
    property Parent: IDispatch readonly dispid 2002;
    function Item(const Index: OleVariant): AddIn; dispid 0;
    function Add(const FileName: WideString): AddIn; dispid 2003;
    procedure Remove(const Index: OleVariant); dispid 2004;
    property _NewEnum: IUnknown readonly dispid -4;
    function _Index(Index: SYSINT): OleVariant; dispid 10;
    property Count: Integer readonly dispid 11;
  end;
...
// *********************************************************************//
  _Presentation = interface(IDispatch)
    ...
    procedure CreateVideo(const FileName: WideString; UseTimingsAndNarrations: WordBool; 
                          ...
                          FramesPerSecond: SYSINT; Quality: SYSINT); safecall;
    property Application: PowerPointApplication read Get_Application;
    property Parent: IDispatch read Get_Parent;
...
// *********************************************************************//
  _PresentationDisp = dispinterface
    ...
    procedure CreateVideo(const FileName: WideString; UseTimingsAndNarrations: WordBool; 
                          DefaultSlideDuration: SYSINT; VertResolution: SYSINT; 
                          FramesPerSecond: SYSINT; Quality: SYSINT); dispid 2123;
  end;
...
// *********************************************************************//
  Research = interface(IDispatch)
    ...
    function Get_Application: PowerPointApplication; safecall;
    function Get_Parent: IDispatch; safecall;
    procedure Query(const ServiceID: WideString; const QueryString: OleVariant; 
                    const QueryLanguage: OleVariant; UseSelection: WordBool; LaunchQuery: WordBool); safecall;
    procedure SetLanguagePair(const Language1: OleVariant; const Language2: OleVariant); safecall;
...
// *********************************************************************//
  ResearchDisp = dispinterface
    ...
    property Parent: IDispatch readonly dispid 2002;
    procedure Query(const ServiceID: WideString; const QueryString: OleVariant; 
                    const QueryLanguage: OleVariant; UseSelection: WordBool; LaunchQuery: WordBool); dispid 2003;
    procedure SetLanguagePair(const Language1: OleVariant; const Language2: OleVariant); dispid 2004;
...
// *********************************************************************//
  ChartDisp = dispinterface
    ...
    property ShowReportFilterFieldButtons: WordBool dispid 2049;
    property ShowLegendFieldButtons: WordBool dispid 2050;
    property ShowAxisFieldButtons: WordBool dispid 2051;
    property ShowValueFieldButtons: WordBool dispid 2052;
    property ShowAllFieldButtons: WordBool dispid 2053;
    property AlternativeText: WideString dispid 2054;
    property Title: WideString dispid 2055;
  end;
...
// *********************************************************************//
  ...
  public
    ...
    procedure LaunchSendToPPTDialog(const SlideUrls: OleVariant);
...
procedure TPowerPointApplication.LaunchSendToPPTDialog(const SlideUrls: OleVariant);
begin
