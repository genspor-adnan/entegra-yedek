...
/****** Object:  UserDefinedFunction [dbo].[fn_VardiyaCikis_Bas_Bit]    Script Date: 10/18/2010 11:38:33 ******/
SET ANSI_NULLS ON
GO
...
ALTER  function [dbo].[fn_VardiyaCikis_Bas_Bit] ( @PERKOD VARCHAR(20),@GIRIS DATETIME, @CIKIS DATETIME )
returns varchar(1000)
as 
begin
	declare @VardiyaCikis varchar(5)
  ...
  AND ISNULL(GUN,'')=(select dbo.fn_gunadi(@GIRIS))) =0 
	...
	SELECT top 1 @VardiyaCikis = BITSA
