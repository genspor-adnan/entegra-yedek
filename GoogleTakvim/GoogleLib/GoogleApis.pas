...
uses
  System.Classes, System.Contnrs, System.SysUtils, Winapi.Windows,
...
type
  ...
  public
    ...
    function GetRawRequestUri: string;
...
function THttpRequestParameterList.GetRawRequestUri: string;
var
  i, cnt: integer;
  Item: THttpRequestParameter;
begin
  Result := '';
  cnt := GetCount;
  for i := 0 to cnt - 1 do
