...
type
  ...
  [IID_IEasyStateImageList]
    function GetImageList(Column: Integer): TImageList;
    property ImageList[Column: Integer]: TImageList read GetImageList;
  end;
...
//  TColumnCreatePaintInfoEvent = procedure(Sender: TCustomEasyListview; var PaintInfo: TEasyColumnPaintInfo) of object;
  ...
  protected
    ...
    function DefaultStateImageList: TImageList;
    ...
    function GetStateImageList(Column: Integer): TImageList; virtual; abstract;
  ...
  public
    ...
    property StateImageList[Column: Integer]: TImageList read GetStateImageList;
    property VAlignment;
  ...
  protected
    ...
    function GetStateImageList(Column: Integer): TImageList; override;
  ...
  public
    ...
    function GetImageList(Column: TEasyColumn; Item: TEasyItem; Image: TEasyImageKind): TImageList; virtual;
    procedure GetImageSize(Item: TEasyItem; Column: TEasyColumn; var ImageW, ImageH: Integer; Image: TEasyImageKind);
    function GetStateImageList(Column: TEasyColumn; Item: TEasyItem): TImageList;
  ...
  public
    function ExpandTextR(Item: TEasyItem; RectArray: TEasyRectArrayObject; SelectType: TEasySelectHitType): TRect; override;
    function GetImageList(Column: TEasyColumn; Item: TEasyItem; Image: TEasyImageKind): TImageList; override;
    function PaintImageSize: TEasyImageSize; override;
    procedure ItemRectArray(Item: TEasyItem; Column: TEasyColumn; ACanvas: TCanvas; const Caption: WideString; var RectArray: TEasyRectArrayObject); override;
    function OverlappedFocus: Boolean; override;
...
//    property ColumnTrack: TEasyHotTrackRectColumns read FColumnTrack write FColumnTrack default [htcImage, htcText];
  ...
  private
    ...
    procedure SetImagesState(const Value: TImageList);
  ...
  protected
    ...
    procedure DoItemGetStateImageList(Item: TEasyItem; Column: Integer; var ImageList: TImageList); virtual;
    ...
    property ImagesState: TImageList read FImagesState write SetImagesState;
...
begin
  ...
  begin
    OwnerListview.DoScroll(FOffsetX - OldOffsetX, FOffsetY - OldOffsetY);
...
begin
  ...
  if WheelMouseDefaultScroll = edwsVert then
    WheelDelta := Groups.CellHeight * Integer(pvParam)
  else
    WheelDelta := Groups.CellWidth * Integer(pvParam);
...
procedure TCustomEasyListview.DoItemGetStateImageList(Item: TEasyItem; Column: Integer; var ImageList: TImageList);
begin
...
procedure TCustomEasyListview.SetImagesState(const Value: TImageList);
begin
...
begin
  ...
  if Value then
  begin
    Columns.Add.Width := OwnerListview.ClientWidth;
    OwnerListview.Groups.Rebuild
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if PressColumn.AutoToggleSortGlyph then
      begin
        ...
        try
          ...
          else if (OwnerListview.Sort.AutoSort) or (PressColumn.AutoSortOnClick) then
            OwnerListview.Sort.SortAll(PressColumn.AutoSortOnClick);
        finally
          OwnerListview.EndUpdate
        end;
      end;
...
function TEasyViewItem.GetImageList(Column: TEasyColumn; Item: TEasyItem; Image: TEasyImageKind): TImageList;
begin
...
function TEasyViewItem.GetStateImageList(Column: TEasyColumn; Item: TEasyItem): TImageList;
begin
        ...
        begin
          ...
          begin
            ...
            if y + 1 < Bits1.Height then
              ...
              NextRow := nil;
            for x := 1 to Bits1.Width - 2 do
            begin
              RGBArrayA := RowA[x];
              RGBArrayB := RowB[x];
              if BlurBits2 and Assigned(NextRow) and Assigned(PrevRow) then
              begin
...
begin
  ...
  begin
    ...
    begin
      ACanvas.Font.Color := OwnerListview.Selection.TextColor;
      if Item <> OwnerListview.Selection.FocusedItem then
         ...
         begin
           ...
           try
             ...
             BitBlt(Bits.Canvas.Handle, 0, 0, Bits.Width, Bits.Height,
               ACanvas.Handle, LocalSelRect.Left, LocalSelRect.Top, SRCCOPY);

             FillGradient(0, 0, GlassBits.Width, GlassBits.Height, GradientTop, GradientBottom,
               0, GlassBits.Height, GlassBits.Canvas);
             BlendBits(GlassBits, Bits, 80, 20, OwnerListview.Selection.BlurAlphaBkGnd);
             BitBlt(ACanvas.Handle, LocalSelRect.Left, LocalSelRect.Top,
...
function TEasyViewTileItem.GetImageList(Column: TEasyColumn; Item: TEasyItem; Image: TEasyImageKind): TImageList;
begin
...
function TEasyViewThumbnailItem.GetImageList(Column: TEasyColumn; Item: TEasyItem; Image: TEasyImageKind): TImageList;
begin
  Result := inherited GetImageList(Column, Item, Image);
  if not Assigned(Result) then
    Result := Item.ImageList[ValidateColumnIndex(Column), eisLarge]
...
function TEasyItemInterfaced.GetStateImageList(Column: Integer): TImageList;
var
...
function TEasyItem.DefaultStateImageList: TImageList;
begin
...
function TEasyItemVirtual.GetStateImageList(Column: Integer): TImageList;
begin
  Result := nil;
...
function TEasyItemStored.GetStateImageList(Column: Integer): TImageList;
begin
  Result := DefaultStateImageList
end;
...
function TEasyBaseGroupStored.GetImageList(Column: Integer; IconSize: TEasyImageSize): TImageList;
begin
  Result := DefaultImageList(IconSize)
end;
...
begin
  ...
  begin
    ...
    begin
      FTaskPanel := TaskPanelClass.Create(OwnerListview);
      ...
      // Make it visible when the grid is rebuild so it won't flicker
    end
  end;
end;
