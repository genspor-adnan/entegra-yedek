...
begin
  ...
  begin
    ...
    BrowseInfoA.lpfn := @MPBrowseForFolderCallback;
    {$ENDIF}
    BrowseInfoA.lpszTitle := PAnsiChar(string(Title));
...
begin
  ...
  begin
    if Assigned(GetDriveTypeW_MP) then
      ...
      DriveType := GetDriveType(PChar(NS.NameForParsing));
...
begin
 ...
 //   ShellDLL := LoadLibrary(PAnsiChar(Shell32));
...
begin
  ...
  if not IsWin95_SR1 then
    Result := GetDiskFreeSpaceFAT32(
      PAnsiChar( string(Drive)), SectorsPerCluster, BytesPerSector, FreeClusters, TotalClusters)
  else
...
begin
  ...
  begin
    ...
    begin
      SetLength(Result, BufferLen);
     { Keep D6 from complaining about suspicious PAnsiChar cast }
      P := @Result[1];
      ...
      try
        ...
        begin
          ...
          begin
            ...
            InvokeInfo.lpVerb := PAnsiChar( string( AVerb))
          end else
...
begin
  ...
  Menu.ExecuteContextMenuVerb(Menu.MsgWnd, Namespaces, Verb);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        H := FindFirstFileA(PAnsiChar(string(NameForParsing)), FindDataA);
        if H <> INVALID_HANDLE_VALUE then
        begin
          Windows.FindClose(H);
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        // This make Win2k, XP and 9x Crash when showing the property sheet
               //         AddKey(DuplicateKey(Reg.CurrentKey), Keys);
                        Reg.CloseKey;
                      end
                    end;
