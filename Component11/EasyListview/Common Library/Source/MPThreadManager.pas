...
begin
  ...
  begin
    if lpClass <> '' then
      ShellExecuteInfoA.lpClass := PAnsiChar(string( lpClass));
    if lpDirectory <> '' then
      ShellExecuteInfoA.lpDirectory := PAnsiChar(string( lpDirectory));
    if lpFile <> '' then
      ShellExecuteInfoA.lpFile := PAnsiChar(string( lpFile));
    if lpParameters <> '' then
      ShellExecuteInfoA.lpParameters := PAnsiChar(string( lpParameters));
    if lpVerb <> '' then
      ShellExecuteInfoA.lpVerb := PAnsiChar(string( lpVerb));
