...
// $Rev: 52393 $
// File generated on 08/02/2016 10:07:22 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Windows\System32\tapi3.dll (1)
...
// SYS_KIND: SYS_WIN32
// Errors:
//   Error creating palette bitmap of (TTAPI) : Server C:\Windows\SysWOW64\tapi3.dll contains no icons
//   Error creating palette bitmap of (TDispatchMapper) : Server C:\Windows\SysWOW64\tapi3.dll contains no icons
//   Error creating palette bitmap of (TRequestMakeCall) : Server C:\Windows\SysWOW64\tapi3.dll contains no icons
// ************************************************************************ //
...
// *********************************************************************//
  ITCollection2 = interface(ITCollection)
    ...
    procedure Add(Index: Integer; const pVariant: OleVariant); safecall;
...
// *********************************************************************//
  ITCollection2Disp = dispinterface
    ['{E6DDDDA5-A6D3-48FF-8737-D32FC4D95477}']
    procedure Add(Index: Integer; const pVariant: OleVariant); dispid 1;
...
// *********************************************************************//
  ITCallInfoDisp = dispinterface
    ...
    procedure GetCallInfoBuffer(CallInfoBuffer: CALLINFO_BUFFER; out pdwSize: LongWord; 
                                out ppCallInfoBuffer: {NOT_OLEAUTO(PByte1)}OleVariant); dispid 65544;
    procedure SetCallInfoBuffer(CallInfoBuffer: CALLINFO_BUFFER; dwSize: LongWord; 
...
// *********************************************************************//
  ITPhoneDisp = dispinterface
    ...
    procedure GetPhoneCapsBuffer(pcbCaps: PHONECAPS_BUFFER; out pdwSize: LongWord; 
                                 out ppPhoneCapsBuffer: {NOT_OLEAUTO(PByte1)}OleVariant); dispid 65553;
...
// *********************************************************************//
  ITTerminalSupport2Disp = dispinterface
    ...
    function EnumeratePluggableTerminalClasses(iidTerminalSuperclass: {NOT_OLEAUTO(TGUID)}OleVariant; 
...
// *********************************************************************//
  ITLegacyCallMediaControlDisp = dispinterface
    ...
    procedure GetID(const pDeviceClass: WideString; out pdwSize: LongWord; 
                    out ppDeviceID: {NOT_OLEAUTO(PByte1)}OleVariant); dispid 196611;
...
// *********************************************************************//
  ITLegacyCallMediaControl2Disp = dispinterface
    ...
    procedure DetectTones(var pToneList: {NOT_OLEAUTO(TAPI_DETECTTONE)}OleVariant; 
                          lNumTones: Integer); dispid 196616;
    ...
    procedure GenerateCustomTones(var pToneList: {NOT_OLEAUTO(TAPI_CUSTOMTONE)}OleVariant; 
                                  lNumTones: Integer; lDuration: Integer); dispid 196619;
    procedure GenerateCustomTonesByCollection(const pCustomToneCollection: ITCollection2; 
...
// *********************************************************************//
  ITFileTrackDisp = dispinterface
    ['{31CA6EA9-C08A-4BEA-8811-8E9C1BA3EA3A}']
    property Format: {NOT_OLEAUTO(PUserType3)}OleVariant dispid 65537;
...
// *********************************************************************//
  ITTAPIDispatchEventNotification = dispinterface
    ...
    function Event(TapiEvent: TAPI_EVENT; const pEvent: IDispatch): HResult; dispid 1;
  end;
...
begin
  Result := DefaultInterface.CallHubs;
end;

function TTAPI.Get_PrivateTAPIObjects: OleVariant;
begin
  Result := DefaultInterface.PrivateTAPIObjects;
end;

procedure TTAPI.Set_EventFilter(plFilterMask: Integer);
begin
  DefaultInterface.EventFilter := plFilterMask;
end;
